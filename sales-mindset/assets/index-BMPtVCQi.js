...
:root{
  --bg:#07070e;--bg2:#0b0b16;--card:#13132a;--card2:#181838;--glass:rgba(19,19,42,.55);
  --accent:#FFD54A;--accent-dim:rgba(255,213,74,.1);--accent-glow:rgba(255,213,74,.3);
  --warm:#FFA726;--green:#00e696;--blue:#64B5F6;--purple:#BA68C8;--red:#ff5f57;
  --white:#fff;--text:#b0b0c8;--muted:#8a8aa4;
  --border:rgba(255,213,74,.07);--border-h:rgba(255,213,74,.22);
  --font:'Inter',-apple-system,BlinkMacSystemFont,sans-serif;--sb:240px;
}
body{font-family:var(--font);background:var(--bg);color:var(--white);display:flex;min-height:100vh;overflow-x:hidden}

.sb{width:var(--sb);position:fixed;top:0;left:0;bottom:0;background:var(--bg2);border-right:1px solid var(--border);padding:24px 16px;display:flex;flex-direction:column;z-index:100;transition:transform .3s}
.sb-logo{font-size:20px;font-weight:800;padding:0 8px 24px}.sb-logo span{color:var(--accent)}
.sb-nav{display:flex;flex-direction:column;gap:4px;flex:1}
.si{display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:10px;font-size:14px;font-weight:500;color:var(--muted);cursor:pointer;transition:all .2s;text-decoration:none;border:1px solid transparent}
.si:hover{color:var(--text);background:rgba(255,255,255,.03)}.si.act{color:var(--accent);background:var(--accent-dim);border-color:var(--border)}
.si-ic{width:20px;text-align:center;font-size:15px}
.sb-d{height:1px;background:var(--border);margin:10px 8px}
.sb-u{display:flex;align-items:center;gap:10px;padding:12px 8px;border-top:1px solid var(--border);margin-top:auto}
.sb-av{width:32px;height:32px;border-radius:8px;background:var(--accent);display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:700;color:var(--bg)}
.sb-un{font-size:13px;font-weight:600}.sb-ur{font-size:11px;color:var(--muted)}
.sb-x{display:none;position:absolute;top:16px;right:16px;background:none;border:none;color:var(--muted);font-size:20px;cursor:pointer}
.mh{display:none;position:fixed;top:0;left:0;right:0;z-index:200;padding:14px 20px;background:rgba(7,7,14,.95);backdrop-filter:blur(16px);border-bottom:1px solid var(--border);align-items:center;justify-content:space-between}
.mh .logo{font-size:18px;font-weight:800}.mh .logo span{color:var(--accent)}
.mb{background:none;border:none;cursor:pointer}.mb span{display:block;width:20px;height:2px;background:#fff;margin:4px 0}

.main{margin-left:var(--sb);flex:1;padding:32px 40px 80px;max-width:780px}
.back{display:inline-flex;align-items:center;gap:6px;color:var(--muted);font-size:13px;font-weight:600;text-decoration:none;margin-bottom:20px;transition:color .2s}.back:hover{color:var(--accent)}
.lesson-badge{font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:var(--accent);margin-bottom:8px}
.lesson-title{font-size:clamp(22px,3vw,28px);font-weight:900;letter-spacing:-.5px;margin-bottom:6px}
.lesson-meta{display:flex;gap:16px;font-size:12px;color:var(--muted);margin-bottom:28px;flex-wrap:wrap}

.lcard{background:var(--glass);backdrop-filter:blur(14px);border:1px solid var(--border);border-radius:20px;padding:28px;margin-bottom:20px;transition:border-color .3s}
.lcard:hover{border-color:var(--border-h)}
.lcard h2{font-size:17px;font-weight:800;letter-spacing:-.2px;margin-bottom:12px;display:flex;align-items:center;gap:10px}
.lcard h2 .ic{font-size:20px}
.lcard p,.lcard li{font-size:14px;color:var(--text);line-height:1.75}
.lcard p{margin-bottom:12px}.lcard p:last-child{margin-bottom:0}
.lcard strong{color:var(--white);font-weight:600}
.lcard em{color:var(--accent);font-style:normal}
.lcard blockquote{background:var(--accent-dim);border-left:3px solid var(--accent);border-radius:0 10px 10px 0;padding:14px 18px;margin:14px 0;font-size:14px;color:var(--text);font-style:italic;line-height:1.6}
.lcard ul{padding-left:20px;margin:10px 0}

.reflect{background:linear-gradient(135deg,rgba(255,213,74,.06),var(--card));border:1px solid var(--border-h);border-radius:16px;padding:22px;text-align:center;margin-bottom:20px}
.reflect-q{font-size:15px;font-weight:700;font-style:italic;line-height:1.5}

.q-item{margin-bottom:18px;padding-bottom:18px;border-bottom:1px solid rgba(255,213,74,.04)}
.q-item:last-child{border-bottom:none;margin-bottom:0}
.q-num{font-size:10px;font-weight:700;color:var(--accent);text-transform:uppercase;letter-spacing:1px;margin-bottom:6px}
.q-text{font-size:14px;font-weight:600;margin-bottom:10px}
.q-opts{display:flex;flex-direction:column;gap:6px}
.qopt{display:flex;align-items:center;gap:10px;padding:10px 14px;border:1px solid var(--border);border-radius:10px;cursor:pointer;transition:all .25s;font-size:13px;color:var(--text)}
.qopt:hover{border-color:var(--border-h);color:var(--white)}
.qopt input{display:none}
.qopt.correct{border-color:rgba(0,230,150,.3);background:rgba(0,230,150,.08);color:var(--green)}
.qopt.wrong{border-color:rgba(255,95,87,.3);background:rgba(255,95,87,.08);color:var(--red)}
.q-fb{font-size:12px;font-weight:600;margin-top:8px;min-height:18px}

.ai-card{background:linear-gradient(135deg,rgba(0,230,150,.05),var(--card));border:1px solid rgba(0,230,150,.12);border-radius:18px;padding:22px;margin-bottom:20px}
.ai-card h2{color:var(--green)}
.ai-meta{display:flex;gap:12px;flex-wrap:wrap;margin:10px 0 14px;font-size:12px;color:var(--muted)}
.ai-btn{background:var(--green);color:var(--bg);border:none;padding:12px 24px;border-radius:10px;font-size:14px;font-weight:700;cursor:pointer;font-family:var(--font);transition:all .3s;margin-top:10px}
.ai-btn:hover{box-shadow:0 4px 16px rgba(0,230,150,.3)}

.iv-card{background:linear-gradient(135deg,rgba(100,181,246,.05),var(--card));border:1px solid rgba(100,181,246,.12);border-radius:18px;padding:22px;margin-bottom:20px}
.iv-card h2{color:var(--blue)}
.iv-tip{background:rgba(100,181,246,.08);border:1px solid rgba(100,181,246,.15);border-radius:10px;padding:12px 14px;font-size:12px;color:var(--blue);margin-top:10px;font-weight:500}

.takeaway{background:var(--accent-dim);border:1px solid var(--border-h);border-radius:16px;padding:22px;text-align:center;margin-bottom:24px}
.takeaway p{font-size:16px;font-weight:700;color:var(--accent)}

.bnav{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:20px}
.bnav-btn{flex:1;min-width:140px;padding:14px 20px;border-radius:12px;font-size:14px;font-weight:700;cursor:pointer;font-family:var(--font);transition:all .3s;text-align:center;text-decoration:none;display:flex;align-items:center;justify-content:center;gap:6px}
.bnav-prev{background:transparent;color:var(--white);border:1px solid var(--border-h)}.bnav-prev:hover{background:var(--accent-dim)}
.bnav-complete{background:var(--accent);color:var(--bg);border:none}.bnav-complete:hover{box-shadow:0 6px 24px var(--accent-glow);transform:translateY(-2px)}
.bnav-complete.done{background:var(--green);pointer-events:none}
.bnav-next{background:transparent;color:var(--white);border:1px solid var(--border-h)}.bnav-next:hover{background:var(--accent-dim)}
.toast{position:fixed;bottom:32px;left:50%;transform:translateX(-50%) translateY(80px);background:var(--green);color:var(--bg);padding:14px 28px;border-radius:14px;font-size:14px;font-weight:700;z-index:999;transition:transform .4s cubic-bezier(.16,1,.3,1);pointer-events:none}
.toast.show{transform:translateX(-50%) translateY(0)}

/* Interactive reveals */
details{background:var(--card);border:1px solid var(--border);border-radius:14px;margin:14px 0;overflow:hidden}
details summary{padding:14px 18px;cursor:pointer;font-size:14px;font-weight:600;color:var(--white);list-style:none;display:flex;align-items:center;gap:8px;transition:background .2s;user-select:none}
details summary:hover{background:rgba(255,255,255,.03)}
details summary::-webkit-details-marker{display:none}
details[open] summary{border-bottom:1px solid var(--border)}
.det-body{padding:16px 18px}
.det-body p,.det-body li{font-size:14px;color:var(--text);line-height:1.75}
.det-body p{margin-bottom:10px}.det-body p:last-child{margin-bottom:0}
.det-body strong{color:var(--white);font-weight:600}
.det-body ol,.det-body ul{padding-left:20px;margin-bottom:10px}
/* Comparison tables */
.cx-tbl{width:100%;border-collapse:collapse;margin:14px 0;font-size:13px;overflow-x:auto;display:block}
.cx-tbl th{padding:10px 14px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;text-align:left;white-space:nowrap}
.cx-tbl td{padding:10px 14px;border-top:1px solid var(--border);vertical-align:top;line-height:1.65;color:var(--text)}
.cx-tbl .bad{background:rgba(255,95,87,.04)}.cx-tbl .good{background:rgba(0,230,150,.04)}
.cx-tbl th.bad{color:var(--red);border-bottom:2px solid rgba(255,95,87,.2)}
.cx-tbl th.good{color:var(--green);border-bottom:2px solid rgba(0,230,150,.2)}
/* Framework tables */
.fw-tbl{width:100%;border-collapse:collapse;margin:14px 0;font-size:13px;overflow-x:auto;display:block}
.fw-tbl th{padding:10px 14px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:var(--accent);text-align:left;border-bottom:2px solid var(--border-h);white-space:nowrap}
.fw-tbl td{padding:10px 14px;border-bottom:1px solid var(--border);color:var(--text);line-height:1.6}
.fw-tbl tr:last-child td{border-bottom:none}
.fw-tbl td:first-child{color:var(--white);font-weight:600}

@media(max-width:860px){
  .sb{transform:translateX(-100%)}.sb.open{transform:translateX(0)}.sb-x{display:block}
  .mh{display:flex}.main{margin-left:0;padding:72px 20px 48px}
}
...
<div class="mh"><div class="logo">Amplify<span>Hub</span></div><button class="mb" id="mobBtn" aria-label="Open navigation menu"><span></span><span></span><span></span></button></div>

<aside class="sb" id="sb">
  <button class="sb-x" id="sbX" aria-label="Close navigation menu">✕</button>
  <div class="sb-logo">Amplify<span>Hub</span></div>
  <nav class="sb-nav">
    <a class="si" href="dashboard.html"><span class="si-ic">🏠</span>Dashboard</a>
    <a class="si act" href="journey.html"><span class="si-ic">🛤</span>Journey</a>
    <a class="si" href="coach-home.html"><span class="si-ic">🤖</span>AI Coach</a>
    <a class="si" href="dashboard.html#challenge"><span class="si-ic">⚡</span>Challenges</a>
    <a class="si" href="dashboard.html#resources"><span class="si-ic">📚</span>Resources</a>
    <div class="sb-d"></div>
    <a class="si" href="settings.html"><span class="si-ic">⚙️</span>Settings</a>
  </nav>
  <div class="sb-u"><div class="sb-av">J</div><div><div class="sb-un">Jawad</div><div class="sb-ur">Pro Member</div></div></div>
</aside>

<div class="main">
  <a href="journey.html" class="back">← Back to Journey</a>
  <div class="lesson-badge">Sales Mindset · Lesson 1 of 8</div>
  <h1 class="lesson-title">Sort, Don't Convert — Your Operating System</h1>
  <div class="lesson-meta"><span>⏱ ~10 min</span><span>🏆 +50 XP</span><span>📖 Module 1: Sales Mindset</span></div>

  <!-- CORE MINDSET -->
  <div class="lcard">
    <h2><span class="ic">📖</span> The Core Operating System</h2>
    <p>Here's the single biggest mindset shift that separates reps who book meetings from reps who burn out:</p>
    <p><strong>You are not here to convince anyone. You are here to sort.</strong></p>
    <p>Most new callers show up believing their job is to take a stranger and somehow <em>talk them into</em> a meeting. That framing is a trap. It turns every "no" into a personal failure and every call into a performance you need to nail.</p>
    <p>The elite mindset flips that completely:</p>
    <blockquote>💡 <strong>Pro-Tip:</strong> Your job on a cold call isn't to convert — it's to sort. You're looking for the people who already have the problem you solve. Everyone else gets a polite "thank you, have a great day."</blockquote>
    <p>When you <strong>sort instead of convert</strong>, three things change overnight:</p>
    <ul>
      <li><strong>Rejection stops hurting</strong> — a "no" just means "not this one"</li>
      <li><strong>Your energy stays high</strong> — you're not performing, you're filtering</li>
      <li><strong>Your conversations get real</strong> — because you're genuinely curious, not desperately pitching</li>
    </ul>
    <p>This isn't a nice theory. <strong>This is the operating system</strong> that every single lesson in this academy runs on.</p>
  </div>

  <!-- THE TRUST GAP -->
  <div class="lcard">
    <h2><span class="ic">🔒</span> The Trust Gap</h2>
    <p>Cold outreach has one defining challenge: <strong>trust.</strong></p>
    <p>When an unfamiliar voice calls, it triggers an automatic instinct — an unknown person is a small threat until proven otherwise. You're not starting at zero. You're starting <strong>slightly below zero.</strong></p>
    <table class="fw-tbl">
      <tr><th>Relationship</th><th>Time They'll Give You</th><th>Why</th></tr>
      <tr><td>Family / close friend</td><td>Minutes, freely</td><td>Deep, established trust</td></tr>
      <tr><td>Acquaintance</td><td>A moderate grace period</td><td>Some trust, some context</td></tr>
      <tr><td>Total stranger (cold call)</td><td>Seconds</td><td>Zero trust, active suspicion</td></tr>
    </table>
    <p>If you don't plan for this reality, you'll wonder why a technically perfect pitch falls flat.</p>
    <p>The pitch was never the problem. <strong>Trust was.</strong> Trust has to be bridged before any amount of value can land.</p>
  </div>

  <!-- THE 85/15 RULE -->
  <div class="lcard">
    <h2><span class="ic">🎯</span> The 85/15 Rule</h2>
    <p>Here's a number worth memorizing:</p>
    <p><strong>85% of a cold call's effectiveness is delivery</strong> — tone, pacing, pauses, emphasis, volume. Only about <strong>15% is the actual words.</strong></p>
    <table class="fw-tbl">
      <tr><th>Factor</th><th>Weight</th><th>What It Means</th></tr>
      <tr><td>Delivery</td><td>85%</td><td>Tone, pace, pauses, and confidence do the heavy lifting</td></tr>
      <tr><td>Script words</td><td>15%</td><td>Your script is the vehicle, not the engine</td></tr>
    </table>
    <p>Think of it like stand-up comedy. Hand a stranger a world-class comedian's exact script, word for word — they still won't land the laughs. The timing, the pauses, the delivery were doing most of the work.</p>
    <p><strong>Cold calling runs on the same principle.</strong></p>
    <blockquote>💡 <strong>Pro-Tip:</strong> The most common beginner complaint — "my script isn't working" — is almost never the real diagnosis. Record five calls and score your own delivery confidence from 1-10 before you touch the script.</blockquote>
  </div>

  <!-- MINDSET SHIFTS — CONTRAST TABLE -->
  <div class="lcard">
    <h2><span class="ic">🔄</span> Six Mindset Shifts to Internalize</h2>
    <p>Each shift below is a belief that <strong>quietly limits new reps</strong>, paired with the belief that replaces it.</p>
    <table class="cx-tbl">
      <tr><th class="bad">❌ The Old Belief</th><th class="good">✅ The New Belief</th></tr>
      <tr><td class="bad">"Cold calling is dying."</td><td class="good">"It's human communication — it can't die while people talk."</td></tr>
      <tr><td class="bad">"I need the perfect script first."</td><td class="good">"Volume is how I find the right script — I can't optimize what I haven't tested."</td></tr>
      <tr><td class="bad">"The right words make the call work."</td><td class="good">"85% is delivery. Words are secondary."</td></tr>
      <tr><td class="bad">"Rejection means I failed."</td><td class="good">"A stranger declining a cold call is neutral, not personal."</td></tr>
      <tr><td class="bad">"I'll personalize once I'm good."</td><td class="good">"5 minutes of prep IS the basic — most reps skip it, which is exactly the edge."</td></tr>
      <tr><td class="bad">"I track meetings — that's what matters."</td><td class="good">"I track calls, conversations, AND meetings. The first two explain the third."</td></tr>
    </table>
  </div>

  <!-- NOTHING-TO-LOSE MINDSET -->
  <div class="lcard">
    <h2><span class="ic">💪</span> The Nothing-to-Lose Mindset</h2>
    <p>Fear of cold calling almost always traces back to treating rejection as a <strong>loss.</strong></p>
    <p>Reframe it: a stranger who didn't know you existed thirty seconds ago <strong>cannot meaningfully reject you.</strong> They can only decline a call from someone they have no relationship with. Those are two very different things.</p>
    <blockquote>"I can live with the discomfort of being told no. I cannot live with knowing I did not do everything in my power to maximize my potential."</blockquote>
    <p>There's a second layer that changes your posture on every call: most prospects <strong>don't know you exist</strong>, don't know a solution to their problem exists, and often don't fully understand the cost of their current problem.</p>
    <p>Seen that way, the call stops being an imposition and becomes a <strong>service.</strong></p>
  </div>

  <!-- EXERCISE -->
  <div class="lcard">
    <h2><span class="ic">✏️</span> Practical Exercises</h2>
    <details>
      <summary>🔍 Exercise 1: The Nothing-to-Lose Declaration</summary>
      <div class="det-body">
        <p>Before your next practice session, write out — in your own words:</p>
        <p><strong>What you CAN live with:</strong> Being told no. Awkward silences. A two-hour block with zero meetings booked.</p>
        <p><strong>What you CANNOT live with:</strong> Knowing you didn't do everything in your power to maximize your potential.</p>
        <p>Read it out loud before you make your first call. This resets your emotional relationship with rejection before a single prospect defines it for you.</p>
      </div>
    </details>
    <details>
      <summary>🔍 Exercise 2: The Awareness Value Statement</summary>
      <div class="det-body">
        <p>Write one paragraph describing what your typical prospect is dealing with that they may not fully understand — the hidden costs, the downstream consequences, the things they've simply normalized.</p>
        <p>Read this before your next call block. It's a direct reminder: <strong>you are providing a service, not creating an interruption.</strong></p>
      </div>
    </details>
    <details>
      <summary>🔍 Exercise 3: Audit Your Opener</summary>
      <div class="det-body">
        <p>Take your current cold call opener and do this:</p>
        <ol>
          <li><strong>Underline</strong> every sentence about you or your company</li>
          <li><strong>Circle</strong> every sentence about the prospect's problem</li>
        </ol>
        <p>If underlines outnumber circles, <strong>the opener needs to be rebuilt from the problem outward.</strong></p>
      </div>
    </details>
  </div>

  <!-- REFLECTION -->
  <div class="reflect"><div class="reflect-q">💭 If a stranger who didn't know you existed thirty seconds ago says "no thanks" — did they reject you as a person, or did they decline a phone call?</div></div>

  <!-- QUIZ -->
  <div class="lcard">
    <h2><span class="ic">🧠</span> Knowledge Check</h2>
    <div class="q-item"><div class="q-num">Q1</div><div class="q-text">The "Sort, Don't Convert" mindset means:</div><div class="q-opts">
      <label class="qopt" data-qi="0" data-oi="0"><input type="radio" name="q0"><span class="qo-text">Try harder to convince every prospect</span></label>
      <label class="qopt" data-qi="0" data-oi="1"><input type="radio" name="q0"><span class="qo-text">Find people who already have the problem you solve, and filter out the rest</span></label>
      <label class="qopt" data-qi="0" data-oi="2"><input type="radio" name="q0"><span class="qo-text">Only call people who are expecting your call</span></label>
      <label class="qopt" data-qi="0" data-oi="3"><input type="radio" name="q0"><span class="qo-text">Sort your contact list alphabetically before calling</span></label>
    </div><div class="q-fb" id="qfb0"></div></div>

    <div class="q-item"><div class="q-num">Q2</div><div class="q-text">Why do strangers only give you seconds on a cold call?</div><div class="q-opts">
      <label class="qopt" data-qi="1" data-oi="0"><input type="radio" name="q1"><span class="qo-text">They're always busy</span></label>
      <label class="qopt" data-qi="1" data-oi="1"><input type="radio" name="q1"><span class="qo-text">They have zero trust and active suspicion toward an unknown caller</span></label>
      <label class="qopt" data-qi="1" data-oi="2"><input type="radio" name="q1"><span class="qo-text">Phone calls are outdated</span></label>
      <label class="qopt" data-qi="1" data-oi="3"><input type="radio" name="q1"><span class="qo-text">They don't like your product</span></label>
    </div><div class="q-fb" id="qfb1"></div></div>

    <div class="q-item"><div class="q-num">Q3</div><div class="q-text">The 85/15 Rule says:</div><div class="q-opts">
      <label class="qopt" data-qi="2" data-oi="0"><input type="radio" name="q2"><span class="qo-text">85% of calls go to voicemail</span></label>
      <label class="qopt" data-qi="2" data-oi="1"><input type="radio" name="q2"><span class="qo-text">85% of effectiveness is your script, 15% is delivery</span></label>
      <label class="qopt" data-qi="2" data-oi="2"><input type="radio" name="q2"><span class="qo-text">85% of effectiveness is delivery (tone, pace, pauses), only 15% is the words</span></label>
      <label class="qopt" data-qi="2" data-oi="3"><input type="radio" name="q2"><span class="qo-text">You should spend 85% of the call talking</span></label>
    </div><div class="q-fb" id="qfb2"></div></div>

    <div class="q-item"><div class="q-num">Q4</div><div class="q-text">When a prospect says "no" on a cold call, it means:</div><div class="q-opts">
      <label class="qopt" data-qi="3" data-oi="0"><input type="radio" name="q3"><span class="qo-text">You're bad at this job</span></label>
      <label class="qopt" data-qi="3" data-oi="1"><input type="radio" name="q3"><span class="qo-text">They declined a call from someone they don't know — it's neutral data, not personal failure</span></label>
      <label class="qopt" data-qi="3" data-oi="2"><input type="radio" name="q3"><span class="qo-text">Your product isn't good enough</span></label>
      <label class="qopt" data-qi="3" data-oi="3"><input type="radio" name="q3"><span class="qo-text">You should stop calling that industry</span></label>
    </div><div class="q-fb" id="qfb3"></div></div>
    <button class="ai-btn" style="background:var(--accent);color:var(--bg);margin-top:14px" id="checkQuiz">Check Answers</button>
  </div>

  <!-- DRILL -->
  <div class="lcard">
    <h2><span class="ic">🎯</span> Today's Drill</h2>
    <p>Say this declaration aloud three times before your next practice session:</p>
    <p><strong>"I am a sorter, not a converter. My job is to find the people who already have the problem I solve. Every 'no' gets me closer to a 'yes.' I have nothing to lose."</strong></p>
    <p>Focus on: steady tone, no rushing, genuine conviction. This is your pre-call warmup from now on.</p>
  </div>

  <!-- AI COACH -->
  <div class="ai-card">
    <h2><span class="ic">🤖</span> Practice with AI Coach</h2>
    <p style="font-size:14px;color:var(--text);margin:8px 0"><strong>Prospect says:</strong> "Look, I'm really not interested. Please don't call again."</p>
    <p style="font-size:13px;color:var(--text)"><strong>Your objective:</strong> Stay calm. Don't take it personally. Respond with grace and a light, curiosity-based question — no defensiveness, no pleading.</p>
    <div class="ai-meta"><span>Difficulty: Easy</span><span>Goal: Practice the "Sort, Don't Convert" mindset in a live rejection scenario.</span></div>
    <a href="coach-home.html" class="ai-btn">Open AI Coach →</a>
  </div>

  <!-- INTERVIEW PREP -->
  <div class="iv-card">
    <h2><span class="ic">🎤</span> Interview Question</h2>
    <blockquote style="background:rgba(100,181,246,.06);border-left:3px solid var(--blue);border-radius:0 10px 10px 0;padding:14px 18px;margin:12px 0;font-style:italic;font-size:14px;color:var(--text)">"Why cold calling? Isn't it dead?"</blockquote>
    <p style="font-size:13px;color:var(--text);margin:8px 0"><strong>Example answer:</strong> Cold calling isn't a marketing tactic — it's human communication. Email can be ignored in half a second. A live human voice creates a different kind of moment. I think of it as a skill that never expires, because technology changes the vehicle but not the fact that people respond to people.</p>
    <div class="iv-tip">💡 Managers love hearing conviction here. Anyone who says "cold calling isn't dead" with specific reasoning immediately signals they won't quietly stop dialing when it gets hard.</div>
  </div>

  <!-- TAKEAWAY -->
  <div class="takeaway"><p>🔑 Sort, don't convert. Rejection is information. Delivery beats words. This is the operating system — everything else is built on it.</p></div>

  <!-- BOTTOM NAV -->
  <div class="bnav">
    <a href="journey.html" class="bnav-btn bnav-prev">← Back to Journey</a>
    <button class="bnav-btn bnav-complete" id="completeBtn">Mark as Complete ✓</button>
    <a href="sales-mindset-2.html" class="bnav-btn bnav-next">Next Lesson →</a>
  </div>
</div>

<div class="toast" id="toast">🎉 Lesson Complete! +50 XP</div>

<script>
const STORAGE_KEY='amplifyHub_journeyProgress';
const MODULE_INDEX=0;
const LESSON_INDEX=0;
const TOTAL_MODULE_LESSONS=8;

function readProgress(){
  try{ const d=JSON.parse(localStorage.getItem(STORAGE_KEY)); return new Set(d?.completedLessons||[]); }catch(e){ return new Set(); }
}
...
function lid(m,l){ return \`m\${m}l\${l}\`; }

const completed=readProgress();
const thisLid=lid(MODULE_INDEX,LESSON_INDEX);
const btn=document.getElementById('completeBtn');
if(completed.has(thisLid)){ btn.textContent='✓ Completed'; btn.classList.add('done'); }

btn.addEventListener('click',function(){
  if(completed.has(thisLid)) return;
  completed.add(thisLid);
...
document.getElementById('checkQuiz').addEventListener('click',function(){
  document.querySelectorAll('.qopt').forEach(opt=>{
    const qi=parseInt(opt.dataset.qi), oi=parseInt(opt.dataset.oi);
    const input=opt.querySelector('input');
    if(!input.checked) return;
    if(oi===answers[qi]){ opt.classList.add('correct'); document.getElementById('qfb'+qi).textContent='✓ Correct!'; document.getElementById('qfb'+qi).style.color='var(--green)'; }
    else{ opt.classList.add('wrong'); document.getElementById('qfb'+qi).textContent='✗ Try again'; document.getElementById('qfb'+qi).style.color='var(--red)'; }
  });
});
...
</html>`},{id:`m0l1`,number:2,title:`Rejection is Information`,shortTitle:`Rejection is Information`,duration:`~8 min`,xp:50,answers:[1,2,1,1],source:`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>AmplifyHub — Rejection is Information</title>
<meta name="description" content="Sales Mindset, part 2 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:type" content="website">
<meta property="og:site_name" content="AmplifyHub">
<meta property="og:title" content="AmplifyHub — Rejection is Information">
<meta property="og:description" content="Sales Mindset, part 2 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:image" content="og-image.png">
<meta name="twitter:card" content="summary_large_image">
<link rel="icon" type="image/svg+xml" href="favicon.svg">
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
...
<div class="main">
  <a href="journey.html" class="back">← Back to Journey</a>
  <div class="lesson-badge">Sales Mindset · Lesson 2 of 8</div>
  <h1 class="lesson-title">Rejection is Information</h1>
  <div class="lesson-meta"><span>⏱ ~8 min</span><span>🏆 +50 XP</span><span>📖 Module 1: Sales Mindset</span></div>

  <!-- EXPLANATION -->
  <div class="lcard">
    <h2><span class="ic">📖</span> Lesson</h2>
    <p>Rejection is the <strong>#1 reason people quit</strong> cold calling.</p>
    <p>Not because the rejection is unbearable. Because they <strong>interpret it as personal failure.</strong></p>
    <p>Here's the reframe that changes everything:</p>
    <p><strong>A "no" is information.</strong> It tells you something — wrong timing, wrong person, wrong approach, or simply not a fit. That data is gold because it helps you adjust.</p>
    <blockquote>💡 <strong>Pro-Tip:</strong> The best SDRs don't avoid rejection. They <em>collect it deliberately</em>, because every "no" narrows the path to "yes." Think like a scientist — a failed experiment isn't failure, it's a data point.</blockquote>
    <p>Here's what a "no" actually looks like when you decode it:</p>
    <table class="fw-tbl">
      <tr><th>What They Say</th><th>What It Actually Means</th><th>What You Do Next</th></tr>
      <tr><td>"Not interested"</td><td>Your opener didn't hook them fast enough</td><td>Refine your first 8 seconds</td></tr>
      <tr><td>"We already have someone"</td><td>They have a provider — doesn't mean they're happy</td><td>Ask a curiosity question about their current setup</td></tr>
      <tr><td>"Send me an email"</td><td>They want you off the phone, not your email</td><td>Acknowledge it, then ask one quick question first</td></tr>
      <tr><td>"Bad timing"</td><td>Might be real, might be a brush-off</td><td>Lock in a specific callback time</td></tr>
    </table>
  </div>

  <!-- EXAMPLE -->
  <div class="lcard">
    <h2><span class="ic">💼</span> Real-World Example</h2>
    <p><strong>Marcus tracked every rejection for a month.</strong> He logged the objection, his response, and the outcome.</p>
    <p>After 200 calls, he spotted the pattern: <strong>60% of his "not interested" responses came within the first 8 seconds</strong> — before he even reached his value statement.</p>
    <p>The diagnosis was clear. His opener was the problem, not his pitch.</p>
    <p>He adjusted his opener to <strong>lead with a question instead of a pitch.</strong> His booking rate doubled in two weeks.</p>
    <table class="cx-tbl">
      <tr><th class="bad">❌ Marcus's Old Opener</th><th class="good">✅ Marcus's New Opener</th></tr>
      <tr><td class="bad">"Hi, I'm Marcus from XYZ. We help businesses increase revenue with our platform..."</td><td class="good">"Quick question — what's the biggest challenge you're facing with [specific thing] right now?"</td></tr>
      <tr><td class="bad">Rejection at 8 seconds. Prospect never heard the value.</td><td class="good">Rejection moved to 45+ seconds. More conversations, more opportunities.</td></tr>
    </table>
    <blockquote>💡 <strong>Pro-Tip:</strong> The rejections didn't stop — but they started happening <em>later</em> in the call. That's the difference between a brush-off and a real conversation.</blockquote>
  </div>

  <!-- EXERCISE -->
  <div class="lcard">
    <h2><span class="ic">✏️</span> Practical Exercise</h2>
    <details>
      <summary>🔍 Click to reveal: The Rejection Log exercise</summary>
      <div class="det-body">
        <p><strong>Build your own Rejection Log.</strong> Create a simple spreadsheet or notebook with three columns:</p>
        <table class="fw-tbl">
          <tr><th>Date</th><th>Objection Heard</th><th>What I Learned</th></tr>
          <tr><td>e.g. July 14</td><td>"We already have someone"</td><td>I rushed past the opener — need to slow down</td></tr>
          <tr><td>e.g. July 14</td><td>"Not interested"</td><td>Came at 6 seconds — they checked out before my value statement</td></tr>
        </table>
        <p>For your next <strong>10 practice calls</strong> (or real calls), log every rejection. After 10 entries, look for patterns:</p>
        <p><strong>What objection appears most? What happens right before it?</strong></p>
        <p>This log turns rejection from an emotional event into a <strong>diagnostic tool.</strong></p>
      </div>
    </details>
  </div>

  <!-- REFLECTION -->
  <div class="reflect"><div class="reflect-q">💭 If you knew that your next 50 rejections would lead directly to your best booking ever, would you start dialing faster?</div></div>

  <!-- QUIZ -->
  <div class="lcard"><h2><span class="ic">🧠</span> Knowledge Check</h2><div class="q-item"><div class="q-num">Q1</div><div class="q-text">Why do most people quit cold calling?</div><div class="q-opts"><label class="qopt" data-qi="0" data-oi="0"><input type="radio" name="q0"><span class="qo-text">The pay is too low</span></label><label class="qopt" data-qi="0" data-oi="1"><input type="radio" name="q0"><span class="qo-text">They interpret rejection as personal failure</span></label><label class="qopt" data-qi="0" data-oi="2"><input type="radio" name="q0"><span class="qo-text">The hours are too long</span></label><label class="qopt" data-qi="0" data-oi="3"><input type="radio" name="q0"><span class="qo-text">They don't like phones</span></label></div><div class="q-fb" id="qfb0"></div></div><div class="q-item"><div class="q-num">Q2</div><div class="q-text">What is the healthiest way to think about a 'no'?</div><div class="q-opts"><label class="qopt" data-qi="1" data-oi="0"><input type="radio" name="q1"><span class="qo-text">It means you're bad at this</span></label><label class="qopt" data-qi="1" data-oi="1"><input type="radio" name="q1"><span class="qo-text">It's a personal attack</span></label><label class="qopt" data-qi="1" data-oi="2"><input type="radio" name="q1"><span class="qo-text">It's a data point that helps you adjust</span></label><label class="qopt" data-qi="1" data-oi="3"><input type="radio" name="q1"><span class="qo-text">It means the product is bad</span></label></div><div class="q-fb" id="qfb1"></div></div><div class="q-item"><div class="q-num">Q3</div><div class="q-text">Marcus improved his booking rate by:</div><div class="q-opts"><label class="qopt" data-qi="2" data-oi="0"><input type="radio" name="q2"><span class="qo-text">Calling more people</span></label><label class="qopt" data-qi="2" data-oi="1"><input type="radio" name="q2"><span class="qo-text">Tracking rejections and adjusting his opener</span></label><label class="qopt" data-qi="2" data-oi="2"><input type="radio" name="q2"><span class="qo-text">Switching to email outreach</span></label><label class="qopt" data-qi="2" data-oi="3"><input type="radio" name="q2"><span class="qo-text">Asking his manager for help</span></label></div><div class="q-fb" id="qfb2"></div></div><div class="q-item"><div class="q-num">Q4</div><div class="q-text">A 'rejection log' helps you:</div><div class="q-opts"><label class="qopt" data-qi="3" data-oi="0"><input type="radio" name="q3"><span class="qo-text">Feel worse about your performance</span></label><label class="qopt" data-qi="3" data-oi="1"><input type="radio" name="q3"><span class="qo-text">Identify patterns in objections</span></label><label class="qopt" data-qi="3" data-oi="2"><input type="radio" name="q3"><span class="qo-text">Avoid difficult prospects</span></label><label class="qopt" data-qi="3" data-oi="3"><input type="radio" name="q3"><span class="qo-text">Reduce the number of calls you make</span></label></div><div class="q-fb" id="qfb3"></div></div><button class="ai-btn" style="background:var(--accent);color:var(--bg);margin-top:14px" id="checkQuiz">Check Answers</button></div>

  <!-- DRILL -->
  <div class="lcard">
    <h2><span class="ic">🎯</span> Today's Drill</h2>
    <p>Say this response to "not interested" aloud <strong>five times:</strong></p>
    <table class="cx-tbl">
      <tr><th class="bad">❌ The Weak Way</th><th class="good">✅ The Elite Way</th></tr>
      <tr><td class="bad">"Oh, okay. Sorry to bother you."</td><td class="good">"Totally fair — most people say that before they see the numbers. Quick question though..."</td></tr>
    </table>
    <p>Focus on: <strong>warm tone</strong>, no defensiveness, natural pause after "quick question though."</p>
    <blockquote>💡 <strong>Pro-Tip:</strong> The pause after "quick question though" is doing the heavy lifting. It signals confidence. Don't rush past it.</blockquote>
  </div>

  <!-- AI COACH -->
  <div class="ai-card">
    <h2><span class="ic">🤖</span> Practice with AI Coach</h2>
    <p style="font-size:14px;color:var(--text);margin:8px 0"><strong>Prospect says:</strong> "We're not interested, thanks."</p>
    <p style="font-size:13px;color:var(--text)"><strong>Your objective:</strong> Stay calm, acknowledge the response, and ask one curiosity question instead of pushing back.</p>
    <div class="ai-meta"><span>Difficulty: Easy</span><span>Goal: The learner practices responding to rejection without defensiveness.</span></div>
    <a href="coach-home.html" class="ai-btn">Open AI Coach →</a>
  </div>
  ...
  <div class="iv-card">
    <h2><span class="ic">🎤</span> Interview Question</h2>
    <blockquote style="background:rgba(100,181,246,.06);border-left:3px solid var(--blue);border-radius:0 10px 10px 0;padding:14px 18px;margin:12px 0;font-style:italic;font-size:14px;color:var(--text)">"How do you handle rejection?"</blockquote>
    <p style="font-size:13px;color:var(--text);margin:8px 0"><strong>Example answer:</strong> I treat rejection as data, not failure. In my practice, I logged every objection and looked for patterns — which helped me adjust my approach and improve my conversion rate over time. A 'no' doesn't discourage me; it sharpens my next call.</p>
    <div class="iv-tip">💡 Show resilience without bravado. Managers want someone who learns from rejection, not someone who claims to never feel it.</div>
  </div>

  <!-- TAKEAWAY -->
  <div class="takeaway"><p>🔑 Rejection isn't the opposite of success. It's the fastest route to it.</p></div>

  <!-- BOTTOM NAV -->
  <div class="bnav">
    <a href="sales-mindset-1.html" class="bnav-btn bnav-prev">← Previous Lesson</a>
    <button class="bnav-btn bnav-complete" id="completeBtn">Mark as Complete ✓</button>
    <a href="sales-mindset-3.html" class="bnav-btn bnav-next">Next Lesson →</a>
  </div>
</div>
...
<script>
// ── PROGRESS SYNC (shared with journey.html) ──
const STORAGE_KEY='amplifyHub_journeyProgress';
const MODULE_INDEX=0; // Sales Mindset is module 0
const LESSON_INDEX=1; // 0-indexed
const TOTAL_MODULE_LESSONS=8;
...
</html>`},{id:`m0l2`,number:3,title:`Confidence Comes From Repetition`,shortTitle:`Confidence Through Repetition`,duration:`~8 min`,xp:50,answers:[2,2,1,2],source:`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>AmplifyHub — Confidence Comes From Repetition</title>
<meta name="description" content="Sales Mindset, part 3 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:type" content="website">
<meta property="og:site_name" content="AmplifyHub">
<meta property="og:title" content="AmplifyHub — Confidence Comes From Repetition">
<meta property="og:description" content="Sales Mindset, part 3 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:image" content="og-image.png">
<meta name="twitter:card" content="summary_large_image">
<link rel="icon" type="image/svg+xml" href="favicon.svg">
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
...
<div class="main">
  <a href="journey.html" class="back">← Back to Journey</a>
  <div class="lesson-badge">Sales Mindset · Lesson 3 of 8</div>
  <h1 class="lesson-title">Confidence Comes From Repetition</h1>
  <div class="lesson-meta"><span>⏱ ~8 min</span><span>🏆 +50 XP</span><span>📖 Module 1: Sales Mindset</span></div>

  <!-- EXPLANATION -->
  <div class="lcard">
    <h2><span class="ic">📖</span> Lesson</h2>
    <p>Confidence on a cold call doesn't come from reading scripts, watching videos, or psyching yourself up in the mirror.</p>
    <p>It comes from <strong>having done the thing enough times that it feels familiar.</strong></p>
    <p>This is why structured practice matters more than motivation. You don't need to feel confident before you start — you need to <strong>start before you feel confident.</strong> The feeling follows the reps.</p>
    <blockquote>💡 <strong>Pro-Tip:</strong> Confidence is not a prerequisite. It's a byproduct. You earn it through repetition, not preparation.</blockquote>
    <p>Think about the first time you drove a car. Hyper-aware of every input — mirrors, pedals, steering, other cars. Now you drive without thinking about it.</p>
    <p><strong>Cold calling works the same way:</strong></p>
    <table class="fw-tbl">
      <tr><th>Stage</th><th>What It Feels Like</th><th>What's Happening</th></tr>
      <tr><td>First 50 calls</td><td>Controlled panic. Every word feels forced.</td><td>You're building raw familiarity with the process</td></tr>
      <tr><td>After 200 calls</td><td>You're having real conversations</td><td>Pattern recognition is replacing conscious effort</td></tr>
      <tr><td>After 500 calls</td><td>You sound like a 10-year veteran</td><td>Execution is largely unconscious and repeatable</td></tr>
    </table>
  </div>
  ...
  <div class="lcard">
    <h2><span class="ic">💼</span> Real-World Example</h2>
    <p><strong>Jenna recorded herself practicing her opener every morning for 30 days straight.</strong> Just 5 minutes. Speaking into her phone's voice recorder.</p>
    <p>She'd listen back, notice <strong>one thing</strong> to fix, and try again. That's it.</p>
    <table class="fw-tbl">
      <tr><th>Day</th><th>What Changed</th></tr>
      <tr><td>Day 1</td><td>Reading the script word-for-word. Robotic. Tense.</td></tr>
      <tr><td>Day 15</td><td>Stopped needing to read the script entirely</td></tr>
      <tr><td>Day 25</td><td>Prospects started commenting she sounded "really natural"</td></tr>
    </table>
    <p>She hadn't changed her script at all. She'd just <strong>repeated it enough that it became hers.</strong></p>
    <blockquote>💡 <strong>Pro-Tip:</strong> The script didn't get better — Jenna's <em>delivery</em> did. Remember the 85/15 Rule from Lesson 1: delivery carries 85% of the call's outcome.</blockquote>
  </div>
  ...
  <div class="lcard">
    <h2><span class="ic">✏️</span> Practical Exercise</h2>
    <details>
      <summary>🔍 Click to reveal: The 5-5-5 Drill</summary>
      <div class="det-body">
        <p><strong>The 5-5-5 Drill — 5 minutes, 5 reps, 5 days.</strong></p>
        <ol>
          <li>Choose your cold call opener</li>
          <li>Set a timer for <strong>5 minutes</strong></li>
          <li>Say it out loud <strong>5 times</strong>, recording yourself each time</li>
          <li>Listen back and pick the <strong>ONE version</strong> that sounded most natural</li>
          <li>Tomorrow, start from that version and do it again</li>
        </ol>
        <p>Repeat for <strong>5 consecutive days.</strong></p>
        <p>By day 5, you will sound noticeably different than day 1. This isn't theory — it's how muscle memory works.</p>
      </div>
    </details>
  </div>

  <!-- REFLECTION -->
  <div class="reflect"><div class="reflect-q">💭 What would change in your life if you practiced one sales skill for just 5 minutes every single day for 90 days?</div></div>

  <!-- QUIZ -->
  <div class="lcard"><h2><span class="ic">🧠</span> Knowledge Check</h2><div class="q-item"><div class="q-num">Q1</div><div class="q-text">Where does real confidence on a cold call come from?</div><div class="q-opts"><label class="qopt" data-qi="0" data-oi="0"><input type="radio" name="q0"><span class="qo-text">Reading motivational quotes</span></label><label class="qopt" data-qi="0" data-oi="1"><input type="radio" name="q0"><span class="qo-text">Natural personality</span></label><label class="qopt" data-qi="0" data-oi="2"><input type="radio" name="q0"><span class="qo-text">Repeated practice until it feels familiar</span></label><label class="qopt" data-qi="0" data-oi="3"><input type="radio" name="q0"><span class="qo-text">Having a great product</span></label></div><div class="q-fb" id="qfb0"></div></div><div class="q-item"><div class="q-num">Q2</div><div class="q-text">How many calls does it typically take before calls start feeling natural?</div><div class="q-opts"><label class="qopt" data-qi="1" data-oi="0"><input type="radio" name="q1"><span class="qo-text">5-10</span></label><label class="qopt" data-qi="1" data-oi="1"><input type="radio" name="q1"><span class="qo-text">20-30</span></label><label class="qopt" data-qi="1" data-oi="2"><input type="radio" name="q1"><span class="qo-text">200+</span></label><label class="qopt" data-qi="1" data-oi="3"><input type="radio" name="q1"><span class="qo-text">1,000+</span></label></div><div class="q-fb" id="qfb1"></div></div><div class="q-item"><div class="q-num">Q3</div><div class="q-text">Jenna's breakthrough happened because:</div><div class="q-opts"><label class="qopt" data-qi="2" data-oi="0"><input type="radio" name="q2"><span class="qo-text">She found a better script</span></label><label class="qopt" data-qi="2" data-oi="1"><input type="radio" name="q2"><span class="qo-text">She repeated the same opener until it became natural</span></label><label class="qopt" data-qi="2" data-oi="2"><input type="radio" name="q2"><span class="qo-text">She switched to email</span></label><label class="qopt" data-qi="2" data-oi="3"><input type="radio" name="q2"><span class="qo-text">Her manager coached her daily</span></label></div><div class="q-fb" id="qfb2"></div></div><div class="q-item"><div class="q-num">Q4</div><div class="q-text">The 5-5-5 Drill focuses on:</div><div class="q-opts"><label class="qopt" data-qi="3" data-oi="0"><input type="radio" name="q3"><span class="qo-text">Calling 5 prospects</span></label><label class="qopt" data-qi="3" data-oi="1"><input type="radio" name="q3"><span class="qo-text">Reading 5 articles about sales</span></label><label class="qopt" data-qi="3" data-oi="2"><input type="radio" name="q3"><span class="qo-text">Repeating your opener 5 times daily for 5 days</span></label><label class="qopt" data-qi="3" data-oi="3"><input type="radio" name="q3"><span class="qo-text">Sending 5 follow-up emails</span></label></div><div class="q-fb" id="qfb3"></div></div><button class="ai-btn" style="background:var(--accent);color:var(--bg);margin-top:14px" id="checkQuiz">Check Answers</button></div>

  <!-- DRILL -->
  <div class="lcard"><h2><span class="ic">🎯</span> Today's Drill</h2><p>Record yourself saying this opener, then play it back:</p><p><strong>"Hey [Name], I know I'm catching you out of the blue — I'll be quick. I work with shops like yours that are looking to fill their schedule with higher-margin jobs. Is that something you're focused on right now?"</strong></p><p>Listen for: pace (too fast?), filler words ("um", "like"), and whether it sounds like a conversation or a performance.</p></div>

  <!-- AI COACH -->
  <div class="ai-card">
    <h2><span class="ic">🤖</span> Practice with AI Coach</h2>
    <p style="font-size:14px;color:var(--text);margin:8px 0"><strong>Prospect says:</strong> "You sound like you're reading from a script."</p>
    <p style="font-size:13px;color:var(--text)"><strong>Your objective:</strong> Acknowledge the feedback honestly, then pivot to a natural question.</p>
    <div class="ai-meta"><span>Difficulty: Medium</span><span>Goal: The learner practices recovering when their delivery sounds rehearsed.</span></div>
    <a href="coach-home.html" class="ai-btn">Open AI Coach →</a>
  </div>
  ...
  <div class="iv-card">
    <h2><span class="ic">🎤</span> Interview Question</h2>
    <blockquote style="background:rgba(100,181,246,.06);border-left:3px solid var(--blue);border-radius:0 10px 10px 0;padding:14px 18px;margin:12px 0;font-style:italic;font-size:14px;color:var(--text)">"How do you prepare for a day of cold calling?"</blockquote>
    <p style="font-size:13px;color:var(--text);margin:8px 0"><strong>Example answer:</strong> I warm up every morning with a 5-minute drill — I practice my opener out loud, listen back, and adjust before I touch the phone. It's like an athlete stretching before a game. By the time I make my first call, I've already heard my own voice at its best.</p>
    <div class="iv-tip">💡 This shows discipline and process — two things hiring managers value more than raw enthusiasm.</div>
  </div>

  <!-- TAKEAWAY -->
  <div class="takeaway"><p>🔑 Don't wait to feel ready. Start, repeat, and let confidence catch up.</p></div>

  <!-- BOTTOM NAV -->
  <div class="bnav">
    <a href="sales-mindset-2.html" class="bnav-btn bnav-prev">← Previous Lesson</a>
    <button class="bnav-btn bnav-complete" id="completeBtn">Mark as Complete ✓</button>
    <a href="sales-mindset-4.html" class="bnav-btn bnav-next">Next Lesson →</a>
  </div>
</div>
...
const STORAGE_KEY='amplifyHub_journeyProgress';
const MODULE_INDEX=0; // Sales Mindset is module 0
const LESSON_INDEX=2; // 0-indexed
const TOTAL_MODULE_LESSONS=8;
...
</html>`},{id:`m0l3`,number:4,title:`Curiosity Beats Persuasion`,shortTitle:`Curiosity Beats Persuasion`,duration:`~8 min`,xp:50,answers:[1,2,1,1],source:`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>AmplifyHub — Curiosity Beats Persuasion</title>
<meta name="description" content="Sales Mindset, part 4 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:type" content="website">
<meta property="og:site_name" content="AmplifyHub">
<meta property="og:title" content="AmplifyHub — Curiosity Beats Persuasion">
<meta property="og:description" content="Sales Mindset, part 4 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:image" content="og-image.png">
<meta name="twitter:card" content="summary_large_image">
<link rel="icon" type="image/svg+xml" href="favicon.svg">
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
...
<div class="main">
  <a href="journey.html" class="back">← Back to Journey</a>
  <div class="lesson-badge">Sales Mindset · Lesson 4 of 8</div>
  <h1 class="lesson-title">Curiosity Beats Persuasion</h1>
  <div class="lesson-meta"><span>⏱ ~8 min</span><span>🏆 +50 XP</span><span>📖 Module 1: Sales Mindset</span></div>

  <!-- EXPLANATION -->
  <div class="lcard">
    <h2><span class="ic">📖</span> Lesson</h2>
    <p>Most new callers think their job is to <strong>convince</strong> the prospect. So they pitch harder, talk faster, and pile on features.</p>
    <p>The prospect feels pressured, puts up walls, and hangs up.</p>
    <p>The counterintuitive truth: <strong>the best cold callers barely pitch at all.</strong></p>
    <p>Instead, they ask questions. They're genuinely curious about the prospect's situation, problems, and goals. This curiosity does something persuasion never can — it makes the prospect <strong>feel heard.</strong></p>
    <blockquote>💡 <strong>Pro-Tip:</strong> When someone feels heard, they open up. When they open up, they share real problems. When they share real problems, you can offer real solutions. The sale happens naturally — no pressure required.</blockquote>
    <p>Here's the chain reaction:</p>
    <table class="fw-tbl">
      <tr><th>Step</th><th>What Happens</th><th>Why It Works</th></tr>
      <tr><td>1. Ask</td><td>You lead with a genuine question</td><td>Prospect feels respected, not targeted</td></tr>
      <tr><td>2. Listen</td><td>Prospect shares their real situation</td><td>They feel heard — walls come down</td></tr>
      <tr><td>3. Connect</td><td>You match their problem to your solution</td><td>The sale feels natural, not forced</td></tr>
    </table>
  </div>
  ...
  <div class="lcard">
    <h2><span class="ic">💼</span> Real-World Example</h2>
    <p><strong>Two SDRs. Same company. Same list. Same week.</strong></p>
    <p>Completely different results:</p>
    <table class="cx-tbl">
      <tr><th class="bad">❌ SDR A — The Pitcher</th><th class="good">✅ SDR B — The Asker</th></tr>
      <tr><td class="bad">"We help businesses increase their revenue by 30% with our platform."</td><td class="good">"Quick question — what's the biggest challenge you're facing with [specific thing] right now?"</td></tr>
      <tr><td class="bad">Prospect hears a pitch. Walls go up. Conversation over.</td><td class="good">Prospect hears curiosity. Walls stay down. Conversation begins.</td></tr>
      <tr><td class="bad"><strong>2 meetings booked</strong></td><td class="good"><strong>11 meetings booked</strong></td></tr>
    </table>
    <p>Same product. Same list. Same script length. The <strong>only</strong> difference: one pitched, the other asked.</p>
    <blockquote>💡 <strong>Pro-Tip:</strong> Notice that SDR B's opener is actually <em>shorter</em> than SDR A's. Curiosity doesn't require more words — it requires better ones.</blockquote>
  </div>
  ...
  <div class="lcard">
    <h2><span class="ic">✏️</span> Practical Exercise</h2>
    <details>
      <summary>🔍 Click to reveal: The Question Flip exercise</summary>
      <div class="det-body">
        <p><strong>The Question Flip — turn every pitch statement into a curiosity question.</strong></p>
        <p>Take your current cold call script or opener. Find every statement and convert it into a question:</p>
        <table class="cx-tbl">
          <tr><th class="bad">❌ Statement (Pitching)</th><th class="good">✅ Question (Curiosity)</th></tr>
          <tr><td class="bad">"We help companies reduce churn"</td><td class="good">"What's your team doing about churn right now?"</td></tr>
          <tr><td class="bad">"Our platform increases revenue by 30%"</td><td class="good">"Are most of your current jobs high-margin work, or more bread-and-butter?"</td></tr>
          <tr><td class="bad">"We work with businesses like yours"</td><td class="good">"What's the biggest bottleneck in your pipeline right now?"</td></tr>
        </table>
        <p>Write at least <strong>3 question-based alternatives</strong>. Pick the one that feels most natural and practice it out loud.</p>
      </div>
    </details>
  </div>

  <!-- REFLECTION -->
  <div class="reflect"><div class="reflect-q">💭 When was the last time someone asked you a genuinely good question — one that made you stop and think? How did it change the conversation?</div></div>

  <!-- QUIZ -->
  <div class="lcard"><h2><span class="ic">🧠</span> Knowledge Check</h2><div class="q-item"><div class="q-num">Q1</div><div class="q-text">Why does curiosity work better than persuasion on a cold call?</div><div class="q-opts"><label class="qopt" data-qi="0" data-oi="0"><input type="radio" name="q0"><span class="qo-text">Prospects like being asked questions for fun</span></label><label class="qopt" data-qi="0" data-oi="1"><input type="radio" name="q0"><span class="qo-text">It makes the prospect feel heard and opens real conversation</span></label><label class="qopt" data-qi="0" data-oi="2"><input type="radio" name="q0"><span class="qo-text">It wastes time so the call is longer</span></label><label class="qopt" data-qi="0" data-oi="3"><input type="radio" name="q0"><span class="qo-text">It avoids the need for a script</span></label></div><div class="q-fb" id="qfb0"></div></div><div class="q-item"><div class="q-num">Q2</div><div class="q-text">SDR B in the example booked more meetings because:</div><div class="q-opts"><label class="qopt" data-qi="1" data-oi="0"><input type="radio" name="q1"><span class="qo-text">They had a better product</span></label><label class="qopt" data-qi="1" data-oi="1"><input type="radio" name="q1"><span class="qo-text">They called more people</span></label><label class="qopt" data-qi="1" data-oi="2"><input type="radio" name="q1"><span class="qo-text">They asked questions instead of pitching</span></label><label class="qopt" data-qi="1" data-oi="3"><input type="radio" name="q1"><span class="qo-text">They had more experience</span></label></div><div class="q-fb" id="qfb1"></div></div><div class="q-item"><div class="q-num">Q3</div><div class="q-text">The 'Question Flip' exercise teaches you to:</div><div class="q-opts"><label class="qopt" data-qi="2" data-oi="0"><input type="radio" name="q2"><span class="qo-text">Avoid making any statements</span></label><label class="qopt" data-qi="2" data-oi="1"><input type="radio" name="q2"><span class="qo-text">Convert pitch statements into curiosity-driven questions</span></label><label class="qopt" data-qi="2" data-oi="2"><input type="radio" name="q2"><span class="qo-text">Ask as many questions as possible</span></label><label class="qopt" data-qi="2" data-oi="3"><input type="radio" name="q2"><span class="qo-text">Never talk about your product</span></label></div><div class="q-fb" id="qfb2"></div></div><div class="q-item"><div class="q-num">Q4</div><div class="q-text">When a prospect feels heard, they typically:</div><div class="q-opts"><label class="qopt" data-qi="3" data-oi="0"><input type="radio" name="q3"><span class="qo-text">Hang up faster</span></label><label class="qopt" data-qi="3" data-oi="1"><input type="radio" name="q3"><span class="qo-text">Share real problems you can solve</span></label><label class="qopt" data-qi="3" data-oi="2"><input type="radio" name="q3"><span class="qo-text">Ask you to send an email</span></label><label class="qopt" data-qi="3" data-oi="3"><input type="radio" name="q3"><span class="qo-text">Request a discount</span></label></div><div class="q-fb" id="qfb3"></div></div><button class="ai-btn" style="background:var(--accent);color:var(--bg);margin-top:14px" id="checkQuiz">Check Answers</button></div>

  <!-- DRILL -->
  <div class="lcard">
    <h2><span class="ic">🎯</span> Today's Drill</h2>
    <p>Practice this curiosity-based opener aloud <strong>five times:</strong></p>
    <table class="cx-tbl">
      <tr><th class="bad">❌ The Old Way (Pitching)</th><th class="good">✅ The New Way (Curiosity)</th></tr>
      <tr><td class="bad">"Hi, I'm calling from XYZ. We help businesses increase their revenue by 30%..."</td><td class="good">"Quick question — are most of the jobs you're booking right now high-margin work, or more of the bread-and-butter stuff?"</td></tr>
    </table>
    <p>Focus on: <strong>genuine tone</strong> (not interrogative), slight upward inflection on "right now," and a <strong>natural pause</strong> after the question to let them answer.</p>
    <blockquote>💡 <strong>Pro-Tip:</strong> The silence after you ask is where the magic happens. Fight the urge to fill it. Let them think. Let them answer.</blockquote>
  </div>

  <!-- AI COACH -->
  <div class="ai-card">
    <h2><span class="ic">🤖</span> Practice with AI Coach</h2>
    <p style="font-size:14px;color:var(--text);margin:8px 0"><strong>Prospect says:</strong> "What does your company do?"</p>
    <p style="font-size:13px;color:var(--text)"><strong>Your objective:</strong> Instead of launching into a pitch, respond with a relevant question that uncovers the prospect's situation first.</p>
    <div class="ai-meta"><span>Difficulty: Medium</span><span>Goal: The learner practices leading with questions instead of feature dumps.</span></div>
    <a href="coach-home.html" class="ai-btn">Open AI Coach →</a>
  </div>
  ...
  <div class="iv-card">
    <h2><span class="ic">🎤</span> Interview Question</h2>
    <blockquote style="background:rgba(100,181,246,.06);border-left:3px solid var(--blue);border-radius:0 10px 10px 0;padding:14px 18px;margin:12px 0;font-style:italic;font-size:14px;color:var(--text)">"What's your approach to a cold call?"</blockquote>
    <p style="font-size:13px;color:var(--text);margin:8px 0"><strong>Example answer:</strong> I lead with curiosity, not a pitch. My first goal on any call is to ask a question that makes the prospect think — something specific to their business. If I can get them talking about their real challenges, the conversation flows naturally from there.</p>
    <div class="iv-tip">💡 Managers love hearing 'I lead with questions' — it signals coachability and a consultative approach.</div>
  </div>

  <!-- TAKEAWAY -->
  <div class="takeaway"><p>🔑 The best salespeople don't talk people into things. They ask their way in.</p></div>

  <!-- BOTTOM NAV -->
  <div class="bnav">
    <a href="sales-mindset-3.html" class="bnav-btn bnav-prev">← Previous Lesson</a>
    <button class="bnav-btn bnav-complete" id="completeBtn">Mark as Complete ✓</button>
    <a href="sales-mindset-5.html" class="bnav-btn bnav-next">Next Lesson →</a>
  </div>
</div>
...
const STORAGE_KEY='amplifyHub_journeyProgress';
const MODULE_INDEX=0; // Sales Mindset is module 0
const LESSON_INDEX=3; // 0-indexed
const TOTAL_MODULE_LESSONS=8;
...
</html>`},{id:`m0l4`,number:5,title:`Activity Creates Opportunity`,shortTitle:`Activity Creates Opportunity`,duration:`~7 min`,xp:50,answers:[1,2,1,0],source:`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>AmplifyHub — Activity Creates Opportunity</title>
<meta name="description" content="Sales Mindset, part 5 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:type" content="website">
<meta property="og:site_name" content="AmplifyHub">
<meta property="og:title" content="AmplifyHub — Activity Creates Opportunity">
<meta property="og:description" content="Sales Mindset, part 5 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:image" content="og-image.png">
<meta name="twitter:card" content="summary_large_image">
<link rel="icon" type="image/svg+xml" href="favicon.svg">
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
...
<div class="main">
  <a href="journey.html" class="back">← Back to Journey</a>
  <div class="lesson-badge">Sales Mindset · Lesson 5 of 8</div>
  <h1 class="lesson-title">Activity Creates Opportunity</h1>
  <div class="lesson-meta"><span>⏱ ~7 min</span><span>🏆 +50 XP</span><span>📖 Module 1: Sales Mindset</span></div>

  <!-- EXPLANATION -->
  <div class="lcard">
    <h2><span class="ic">📖</span> Lesson</h2>
    <p>New SDRs obsess over quality — the perfect script, the perfect prospect, the perfect time to call.</p>
    <p>This creates <strong>paralysis.</strong> They prepare endlessly and dial rarely.</p>
    <p>Here's the uncomfortable truth: <strong>volume is the engine of cold calling.</strong> Not because every call will convert, but because you can't predict which one will.</p>
    <p>The math is brutally simple:</p>
    <table class="fw-tbl">
      <tr><th>Conversion Rate</th><th>Calls Needed</th><th>Meetings Booked</th></tr>
      <tr><td>1 in 20 (5%)</td><td>20 calls</td><td>1 meeting</td></tr>
      <tr><td>1 in 20 (5%)</td><td>100 calls</td><td>5 meetings</td></tr>
      <tr><td>1 in 20 (5%)</td><td>200 calls</td><td>10 meetings</td></tr>
    </table>
    <blockquote>💡 <strong>Pro-Tip:</strong> Activity creates opportunity in ways you can't plan for. The call you almost didn't make becomes your best booking. The "wrong number" turns out to know exactly who you need to talk to. None of this happens without volume.</blockquote>
  </div>

  <!-- EXAMPLE -->
  <div class="lcard">
    <h2><span class="ic">💼</span> Real-World Example</h2>
    <p><strong>Two new SDRs. Same company. Same start date.</strong> Opposite strategies:</p>
    <table class="cx-tbl">
      <tr><th class="bad">❌ David — The Perfectionist</th><th class="good">✅ Alex — The Volume-First Rep</th></tr>
      <tr><td class="bad">Spent 2 weeks perfecting his script before making a single call</td><td class="good">Started dialing on day one with a rough script</td></tr>
      <tr><td class="bad">Made 8 calls in his entire first week</td><td class="good">Made 40 calls in his first week</td></tr>
      <tr><td class="bad">By week 3: <strong>0 meetings</strong>, script still felt wrong because he'd never tested it</td><td class="good">By week 3: <strong>6 meetings</strong> booked, script refined by real conversations</td></tr>
    </table>
    <p>Alex's "bad" script, <strong>pressure-tested by real prospects</strong>, became better than David's "perfect" one ever could.</p>
    <blockquote>💡 <strong>Pro-Tip:</strong> You can't optimize what you haven't tested. Volume is how you find the right script — not the other way around.</blockquote>
  </div>
  ...
  <div class="lcard">
    <h2><span class="ic">✏️</span> Practical Exercise</h2>
    <details>
      <summary>🔍 Click to reveal: The 10-Call Block exercise</summary>
      <div class="det-body">
        <p><strong>The 10-Call Block — build the muscle of momentum.</strong></p>
        <ol>
          <li>Set a timer for <strong>30 minutes</strong></li>
          <li>Make <strong>10 practice calls</strong> (use AI Coach if you don't have real prospects)</li>
          <li><strong>Don't stop to perfect anything between calls</strong> — just dial, deliver, hang up, dial again</li>
          <li>After all 10, note: which call felt best? Which opener landed?</li>
        </ol>
        <p>The rule: <strong>no email, no browsing, no CRM cleanup between dials.</strong> Just calls.</p>
        <p>Two uninterrupted blocks can produce more real volume than a full day of scattered dialing.</p>
      </div>
    </details>
  </div>

  <!-- REFLECTION -->
  <div class="reflect"><div class="reflect-q">💭 What are you perfecting right now that you could test instead?</div></div>

  <!-- QUIZ -->
  <div class="lcard"><h2><span class="ic">🧠</span> Knowledge Check</h2><div class="q-item"><div class="q-num">Q1</div><div class="q-text">What is the biggest mistake new SDRs make?</div><div class="q-opts"><label class="qopt" data-qi="0" data-oi="0"><input type="radio" name="q0"><span class="qo-text">Calling too many people</span></label><label class="qopt" data-qi="0" data-oi="1"><input type="radio" name="q0"><span class="qo-text">Over-preparing and under-dialing</span></label><label class="qopt" data-qi="0" data-oi="2"><input type="radio" name="q0"><span class="qo-text">Using the wrong CRM</span></label><label class="qopt" data-qi="0" data-oi="3"><input type="radio" name="q0"><span class="qo-text">Not reading enough books</span></label></div><div class="q-fb" id="qfb0"></div></div><div class="q-item"><div class="q-num">Q2</div><div class="q-text">If 1 in 20 calls leads to a meeting, how many calls do you need for 5 meetings?</div><div class="q-opts"><label class="qopt" data-qi="1" data-oi="0"><input type="radio" name="q1"><span class="qo-text">20</span></label><label class="qopt" data-qi="1" data-oi="1"><input type="radio" name="q1"><span class="qo-text">50</span></label><label class="qopt" data-qi="1" data-oi="2"><input type="radio" name="q1"><span class="qo-text">100</span></label><label class="qopt" data-qi="1" data-oi="3"><input type="radio" name="q1"><span class="qo-text">200</span></label></div><div class="q-fb" id="qfb1"></div></div><div class="q-item"><div class="q-num">Q3</div><div class="q-text">Why did Alex outperform David?</div><div class="q-opts"><label class="qopt" data-qi="2" data-oi="0"><input type="radio" name="q2"><span class="qo-text">Alex had a better script</span></label><label class="qopt" data-qi="2" data-oi="1"><input type="radio" name="q2"><span class="qo-text">Alex made more calls and refined through real feedback</span></label><label class="qopt" data-qi="2" data-oi="2"><input type="radio" name="q2"><span class="qo-text">Alex had easier prospects</span></label><label class="qopt" data-qi="2" data-oi="3"><input type="radio" name="q2"><span class="qo-text">Alex worked longer hours</span></label></div><div class="q-fb" id="qfb2"></div></div><div class="q-item"><div class="q-num">Q4</div><div class="q-text">Activity creates opportunity because:</div><div class="q-opts"><label class="qopt" data-qi="3" data-oi="0"><input type="radio" name="q3"><span class="qo-text">More calls = more chances, and you can't predict which call converts</span></label><label class="qopt" data-qi="3" data-oi="1"><input type="radio" name="q3"><span class="qo-text">Calling a lot impresses your manager</span></label><label class="qopt" data-qi="3" data-oi="2"><input type="radio" name="q3"><span class="qo-text">It fills your CRM with data</span></label><label class="qopt" data-qi="3" data-oi="3"><input type="radio" name="q3"><span class="qo-text">It makes the day go faster</span></label></div><div class="q-fb" id="qfb3"></div></div><button class="ai-btn" style="background:var(--accent);color:var(--bg);margin-top:14px" id="checkQuiz">Check Answers</button></div>

  <!-- DRILL -->
  <div class="lcard"><h2><span class="ic">🎯</span> Today's Drill</h2><p>Say this affirmation aloud three times, then immediately do a practice opener:</p><p><strong>"I don't need to be perfect. I need to be present. Every dial is a chance."</strong></p><p>Then deliver your opener to an imaginary prospect. No pausing, no restarting. Just go.</p></div>

  <!-- AI COACH -->
  <div class="ai-card">
    <h2><span class="ic">🤖</span> Practice with AI Coach</h2>
    <p style="font-size:14px;color:var(--text);margin:8px 0"><strong>Prospect says:</strong> "You're the third person to call me today."</p>
    <p style="font-size:13px;color:var(--text)"><strong>Your objective:</strong> Acknowledge the interruption with empathy and differentiate yourself with a relevant question rather than more pitching.</p>
    <div class="ai-meta"><span>Difficulty: Medium</span><span>Goal: The learner practices maintaining composure and standing out in a high-volume environment.</span></div>
    <a href="coach-home.html" class="ai-btn">Open AI Coach →</a>
  </div>
  ...
  <div class="iv-card">
    <h2><span class="ic">🎤</span> Interview Question</h2>
    <blockquote style="background:rgba(100,181,246,.06);border-left:3px solid var(--blue);border-radius:0 10px 10px 0;padding:14px 18px;margin:12px 0;font-style:italic;font-size:14px;color:var(--text)">"How do you stay productive during a slow day?"</blockquote>
    <p style="font-size:13px;color:var(--text);margin:8px 0"><strong>Example answer:</strong> I set activity blocks — 10 calls in 30 minutes, no stopping. On slow days, I trust the volume. Some of my best conversations have come from calls I almost didn't make because the morning felt slow.</p>
    <div class="iv-tip">💡 Showing you understand activity-based selling tells a hiring manager you won't crumble on tough days.</div>
  </div>

  <!-- TAKEAWAY -->
  <div class="takeaway"><p>🔑 You can't steer a parked car. Start dialing and let momentum do the rest.</p></div>

  <!-- BOTTOM NAV -->
  <div class="bnav">
    <a href="sales-mindset-4.html" class="bnav-btn bnav-prev">← Previous Lesson</a>
    <button class="bnav-btn bnav-complete" id="completeBtn">Mark as Complete ✓</button>
    <a href="sales-mindset-6.html" class="bnav-btn bnav-next">Next Lesson →</a>
  </div>
</div>
...
const STORAGE_KEY='amplifyHub_journeyProgress';
const MODULE_INDEX=0; // Sales Mindset is module 0
const LESSON_INDEX=4; // 0-indexed
const TOTAL_MODULE_LESSONS=8;
...
</html>`},{id:`m0l5`,number:6,title:`Consistency Beats Motivation`,shortTitle:`Consistency Beats Motivation`,duration:`~7 min`,xp:50,answers:[1,2,1,1],source:`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>AmplifyHub — Consistency Beats Motivation</title>
<meta name="description" content="Sales Mindset, part 6 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:type" content="website">
<meta property="og:site_name" content="AmplifyHub">
<meta property="og:title" content="AmplifyHub — Consistency Beats Motivation">
<meta property="og:description" content="Sales Mindset, part 6 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:image" content="og-image.png">
<meta name="twitter:card" content="summary_large_image">
<link rel="icon" type="image/svg+xml" href="favicon.svg">
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
...
<div class="main">
  <a href="journey.html" class="back">← Back to Journey</a>
  <div class="lesson-badge">Sales Mindset · Lesson 6 of 8</div>
  <h1 class="lesson-title">Consistency Beats Motivation</h1>
  <div class="lesson-meta"><span>⏱ ~7 min</span><span>🏆 +50 XP</span><span>📖 Module 1: Sales Mindset</span></div>

  <!-- EXPLANATION -->
  <div class="lcard"><h2><span class="ic">📖</span> Lesson</h2><p>Motivation is unreliable. Some mornings you'll wake up fired up and ready to crush it. Other mornings you'll want to do anything except pick up the phone. If you only work when you're motivated, your results will be wildly inconsistent.</p><p><strong>Consistency is the secret weapon of top performers.</strong> They don't perform well because they feel great — they feel great because they show up consistently. The streak creates the confidence, not the other way around.</p><p>Think of it like going to the gym. Nobody wants to go every single day. But the people who show up on the days they don't feel like it are the ones who actually transform. Cold calling works identically.</p></div>

  <!-- EXAMPLE -->
  <div class="lcard"><h2><span class="ic">💼</span> Real-World Example</h2><p><strong>Real SDR Example:</strong> Two SDRs had the same monthly target: 15 meetings. SDR A went on "hot streaks" — some weeks making 80 calls, other weeks making 12. SDR B made exactly 25 calls every single day, five days a week. At month-end, SDR A hit 11 meetings. SDR B hit 19. SDR B didn't have better days — she just never had zero days.</p></div>

  <!-- EXERCISE -->
  <div class="lcard"><h2><span class="ic">✏️</span> Practical Exercise</h2><p><strong>Exercise — The Minimum Viable Day:</strong> Define your "floor" — the absolute minimum you'll do on your worst day. Example: "Even on my worst day, I will make 5 calls and practice my opener once." Write this down and put it somewhere you'll see it every morning. The goal isn't to have great days — it's to eliminate zero days.</p></div>

  <!-- REFLECTION -->
  <div class="reflect"><div class="reflect-q">💭 What would happen to your results if you never had another zero day — if you always did at least your minimum?</div></div>

  <!-- QUIZ -->
  <div class="lcard"><h2><span class="ic">🧠</span> Knowledge Check</h2><div class="q-item"><div class="q-num">Q1</div><div class="q-text">Why is consistency more important than motivation?</div><div class="q-opts"><label class="qopt" data-qi="0" data-oi="0"><input type="radio" name="q0"><span class="qo-text">Motivation is always available</span></label><label class="qopt" data-qi="0" data-oi="1"><input type="radio" name="q0"><span class="qo-text">Consistency eliminates zero days and compounds results</span></label><label class="qopt" data-qi="0" data-oi="2"><input type="radio" name="q0"><span class="qo-text">Motivated people are less skilled</span></label><label class="qopt" data-qi="0" data-oi="3"><input type="radio" name="q0"><span class="qo-text">Consistency doesn't require effort</span></label></div><div class="q-fb" id="qfb0"></div></div><div class="q-item"><div class="q-num">Q2</div><div class="q-text">SDR B outperformed SDR A because:</div><div class="q-opts"><label class="qopt" data-qi="1" data-oi="0"><input type="radio" name="q1"><span class="qo-text">She had better prospects</span></label><label class="qopt" data-qi="1" data-oi="1"><input type="radio" name="q1"><span class="qo-text">She was more talented</span></label><label class="qopt" data-qi="1" data-oi="2"><input type="radio" name="q1"><span class="qo-text">She never had zero days — consistent daily volume</span></label><label class="qopt" data-qi="1" data-oi="3"><input type="radio" name="q1"><span class="qo-text">She worked weekends</span></label></div><div class="q-fb" id="qfb1"></div></div><div class="q-item"><div class="q-num">Q3</div><div class="q-text">What is a 'Minimum Viable Day'?</div><div class="q-opts"><label class="qopt" data-qi="2" data-oi="0"><input type="radio" name="q2"><span class="qo-text">A day off</span></label><label class="qopt" data-qi="2" data-oi="1"><input type="radio" name="q2"><span class="qo-text">The absolute minimum activity you commit to on your worst day</span></label><label class="qopt" data-qi="2" data-oi="2"><input type="radio" name="q2"><span class="qo-text">A day where you only send emails</span></label><label class="qopt" data-qi="2" data-oi="3"><input type="radio" name="q2"><span class="qo-text">A short workday</span></label></div><div class="q-fb" id="qfb2"></div></div><div class="q-item"><div class="q-num">Q4</div><div class="q-text">The streak creates the confidence means:</div><div class="q-opts"><label class="qopt" data-qi="3" data-oi="0"><input type="radio" name="q3"><span class="qo-text">You need to feel confident first</span></label><label class="qopt" data-qi="3" data-oi="1"><input type="radio" name="q3"><span class="qo-text">Showing up consistently builds the confidence over time</span></label><label class="qopt" data-qi="3" data-oi="2"><input type="radio" name="q3"><span class="qo-text">Streaks don't matter</span></label><label class="qopt" data-qi="3" data-oi="3"><input type="radio" name="q3"><span class="qo-text">Confidence comes from reading</span></label></div><div class="q-fb" id="qfb3"></div></div><button class="ai-btn" style="background:var(--accent);color:var(--bg);margin-top:14px" id="checkQuiz">Check Answers</button></div>

  <!-- DRILL -->
  <div class="lcard"><h2><span class="ic">🎯</span> Today's Drill</h2><p>Write down your Minimum Viable Day commitment and say it aloud:</p><p><strong>"Even on my worst day, I will ________."</strong></p><p>Examples: "make 5 calls," "practice one objection response," "review one lesson." Say it like a promise, not a wish.</p></div>

  <!-- AI COACH -->
  <div class="ai-card">
    <h2><span class="ic">🤖</span> Practice with AI Coach</h2>
    <p style="font-size:14px;color:var(--text);margin:8px 0"><strong>Prospect says:</strong> "I'm really busy, can you call back another time?"</p>
    <p style="font-size:13px;color:var(--text)"><strong>Your objective:</strong> Respect their time, suggest a specific callback window, and secure a commitment.</p>
    <div class="ai-meta"><span>Difficulty: Easy</span><span>Goal: The learner practices persistence without pressure — a core consistency skill.</span></div>
    <a href="coach-home.html" class="ai-btn">Open AI Coach →</a>
  </div>
  ...
  <div class="iv-card">
    <h2><span class="ic">🎤</span> Interview Question</h2>
    <blockquote style="background:rgba(100,181,246,.06);border-left:3px solid var(--blue);border-radius:0 10px 10px 0;padding:14px 18px;margin:12px 0;font-style:italic;font-size:14px;color:var(--text)">"How do you stay consistent when you're not seeing results?"</blockquote>
    <p style="font-size:13px;color:var(--text);margin:8px 0"><strong>Example answer:</strong> I set a daily floor — a minimum I hit no matter what. On tough days, I focus on that floor rather than the outcome. I've found that consistency compounds: results always follow when you eliminate zero days.</p>
    <div class="iv-tip">💡 This answer shows maturity and grit — exactly what managers look for in someone who'll survive ramp.</div>
  </div>

  <!-- TAKEAWAY -->
  <div class="takeaway"><p>🔑 You don't rise to the level of your motivation. You fall to the level of your systems.</p></div>

  <!-- BOTTOM NAV -->
  <div class="bnav">
    <a href="sales-mindset-5.html" class="bnav-btn bnav-prev">← Previous Lesson</a>
    <button class="bnav-btn bnav-complete" id="completeBtn">Mark as Complete ✓</button>
    <a href="sales-mindset-7.html" class="bnav-btn bnav-next">Next Lesson →</a>
  </div>
</div>
...
const STORAGE_KEY='amplifyHub_journeyProgress';
const MODULE_INDEX=0; // Sales Mindset is module 0
const LESSON_INDEX=5; // 0-indexed
const TOTAL_MODULE_LESSONS=8;
...
</html>`},{id:`m0l6`,number:7,title:`Think Like a Consultant`,shortTitle:`Think Like a Consultant`,duration:`~8 min`,xp:50,answers:[1,2,1,1],source:`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>AmplifyHub — Think Like a Consultant</title>
<meta name="description" content="Sales Mindset, part 7 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:type" content="website">
<meta property="og:site_name" content="AmplifyHub">
<meta property="og:title" content="AmplifyHub — Think Like a Consultant">
<meta property="og:description" content="Sales Mindset, part 7 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:image" content="og-image.png">
<meta name="twitter:card" content="summary_large_image">
<link rel="icon" type="image/svg+xml" href="favicon.svg">
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
...
<div class="main">
  <a href="journey.html" class="back">← Back to Journey</a>
  <div class="lesson-badge">Sales Mindset · Lesson 7 of 8</div>
  <h1 class="lesson-title">Think Like a Consultant</h1>
  <div class="lesson-meta"><span>⏱ ~8 min</span><span>🏆 +50 XP</span><span>📖 Module 1: Sales Mindset</span></div>

  <!-- EXPLANATION -->
  <div class="lcard"><h2><span class="ic">📖</span> Lesson</h2><p>The worst cold callers sound like they're selling something. The best ones sound like they're <strong>helping with something.</strong></p><p>The shift from "salesperson" to "consultant" isn't about what you say — it's about how you think. A salesperson thinks: "How do I get this person to buy?" A consultant thinks: "Does this person have a problem I can actually solve?"</p><p>This mindset changes everything: your tone becomes calmer, your questions become sharper, and your pitch becomes a natural recommendation instead of a pressure tactic. Prospects can feel the difference instantly — and they respond to it.</p></div>

  <!-- EXAMPLE -->
  <div class="lcard"><h2><span class="ic">💼</span> Real-World Example</h2><p><strong>Real SDR Example:</strong> Kira sold digital marketing services. Instead of pitching features, she'd say: "I was looking at your Google Business profile and noticed a few things that might be costing you leads. Would it be helpful if I walked you through what I saw?" This wasn't a pitch — it was a genuine observation. Prospects said yes to that conversation 40% of the time, compared to 8% with her old feature-based opener.</p></div>

  <!-- EXERCISE -->
  <div class="lcard"><h2><span class="ic">✏️</span> Practical Exercise</h2><p><strong>Exercise — The Value Audit:</strong> Before your next call (or practice call), write down three specific things you genuinely believe your product/service solves for the prospect. Not features — problems. Then rewrite your opener so it references one of those problems instead of any feature. Test it on your next call.</p></div>

  <!-- REFLECTION -->
  <div class="reflect"><div class="reflect-q">💭 If you were the prospect, would you want to talk to you? What would make you say yes?</div></div>

  <!-- QUIZ -->
  <div class="lcard"><h2><span class="ic">🧠</span> Knowledge Check</h2><div class="q-item"><div class="q-num">Q1</div><div class="q-text">What's the key difference between a salesperson and a consultant?</div><div class="q-opts"><label class="qopt" data-qi="0" data-oi="0"><input type="radio" name="q0"><span class="qo-text">Consultants charge more</span></label><label class="qopt" data-qi="0" data-oi="1"><input type="radio" name="q0"><span class="qo-text">Consultants focus on solving problems, not pushing products</span></label><label class="qopt" data-qi="0" data-oi="2"><input type="radio" name="q0"><span class="qo-text">Salespeople are less experienced</span></label><label class="qopt" data-qi="0" data-oi="3"><input type="radio" name="q0"><span class="qo-text">There is no difference</span></label></div><div class="q-fb" id="qfb0"></div></div><div class="q-item"><div class="q-num">Q2</div><div class="q-text">Kira improved her success rate by:</div><div class="q-opts"><label class="qopt" data-qi="1" data-oi="0"><input type="radio" name="q1"><span class="qo-text">Pitching more aggressively</span></label><label class="qopt" data-qi="1" data-oi="1"><input type="radio" name="q1"><span class="qo-text">Offering discounts</span></label><label class="qopt" data-qi="1" data-oi="2"><input type="radio" name="q1"><span class="qo-text">Leading with a genuine observation about the prospect's business</span></label><label class="qopt" data-qi="1" data-oi="3"><input type="radio" name="q1"><span class="qo-text">Calling more people</span></label></div><div class="q-fb" id="qfb1"></div></div><div class="q-item"><div class="q-num">Q3</div><div class="q-text">The consultant mindset changes your:</div><div class="q-opts"><label class="qopt" data-qi="2" data-oi="0"><input type="radio" name="q2"><span class="qo-text">Script length</span></label><label class="qopt" data-qi="2" data-oi="1"><input type="radio" name="q2"><span class="qo-text">Tone, questions, and how prospects perceive you</span></label><label class="qopt" data-qi="2" data-oi="2"><input type="radio" name="q2"><span class="qo-text">Working hours</span></label><label class="qopt" data-qi="2" data-oi="3"><input type="radio" name="q2"><span class="qo-text">Product knowledge</span></label></div><div class="q-fb" id="qfb2"></div></div><div class="q-item"><div class="q-num">Q4</div><div class="q-text">A 'Value Audit' helps you:</div><div class="q-opts"><label class="qopt" data-qi="3" data-oi="0"><input type="radio" name="q3"><span class="qo-text">List product features</span></label><label class="qopt" data-qi="3" data-oi="1"><input type="radio" name="q3"><span class="qo-text">Identify the real problems you solve for the prospect</span></label><label class="qopt" data-qi="3" data-oi="2"><input type="radio" name="q3"><span class="qo-text">Calculate your commission</span></label><label class="qopt" data-qi="3" data-oi="3"><input type="radio" name="q3"><span class="qo-text">Write longer emails</span></label></div><div class="q-fb" id="qfb3"></div></div><button class="ai-btn" style="background:var(--accent);color:var(--bg);margin-top:14px" id="checkQuiz">Check Answers</button></div>

  <!-- DRILL -->
  <div class="lcard"><h2><span class="ic">🎯</span> Today's Drill</h2><p>Rewrite this pushy opener into a consultative one:</p><p>Before: <em>"We offer the best auto detailing leads in the city."</em></p><p>After (say aloud): <strong>"I noticed your shop doesn't show up in a few searches where your competitors do. Would it be worth a quick look at what's happening there?"</strong></p><p>Focus on: genuine helpfulness, specific observation, low-pressure question.</p></div>

  <!-- AI COACH -->
  <div class="ai-card">
    <h2><span class="ic">🤖</span> Practice with AI Coach</h2>
    <p style="font-size:14px;color:var(--text);margin:8px 0"><strong>Prospect says:</strong> "We already have a provider for that."</p>
    <p style="font-size:13px;color:var(--text)"><strong>Your objective:</strong> Respond consultatively — acknowledge their current provider and ask what they'd improve about the experience if they could.</p>
    <div class="ai-meta"><span>Difficulty: Hard</span><span>Goal: The learner practices the consultant reframe when facing competitive objections.</span></div>
    <a href="coach-home.html" class="ai-btn">Open AI Coach →</a>
  </div>
  ...
  <div class="iv-card">
    <h2><span class="ic">🎤</span> Interview Question</h2>
    <blockquote style="background:rgba(100,181,246,.06);border-left:3px solid var(--blue);border-radius:0 10px 10px 0;padding:14px 18px;margin:12px 0;font-style:italic;font-size:14px;color:var(--text)">"How would you describe your sales style?"</blockquote>
    <p style="font-size:13px;color:var(--text);margin:8px 0"><strong>Example answer:</strong> Consultative. My goal on every call is to understand whether the prospect has a problem I can genuinely help with — not to push a product. I've found that when you lead with real value and curiosity, the sale happens naturally.</p>
    <div class="iv-tip">💡 Every hiring manager prefers 'consultative' over 'aggressive.' This answer signals coachability and customer focus.</div>
  </div>

  <!-- TAKEAWAY -->
  <div class="takeaway"><p>🔑 Stop trying to sell. Start trying to help. The pipeline follows.</p></div>

  <!-- BOTTOM NAV -->
  <div class="bnav">
    <a href="sales-mindset-6.html" class="bnav-btn bnav-prev">← Previous Lesson</a>
    <button class="bnav-btn bnav-complete" id="completeBtn">Mark as Complete ✓</button>
    <a href="sales-mindset-8.html" class="bnav-btn bnav-next">Next Lesson →</a>
  </div>
</div>
...
const STORAGE_KEY='amplifyHub_journeyProgress';
const MODULE_INDEX=0; // Sales Mindset is module 0
const LESSON_INDEX=6; // 0-indexed
const TOTAL_MODULE_LESSONS=8;
...
</html>`},{id:`m0l7`,number:8,title:`Becoming Interview Ready`,shortTitle:`Becoming Interview Ready`,duration:`~10 min`,xp:50,answers:[2,1,1,1],source:`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>AmplifyHub — Becoming Interview Ready</title>
<meta name="description" content="Sales Mindset, part 8 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:type" content="website">
<meta property="og:site_name" content="AmplifyHub">
<meta property="og:title" content="AmplifyHub — Becoming Interview Ready">
<meta property="og:description" content="Sales Mindset, part 8 of the AmplifyHub series - mental frameworks for confident cold calling.">
<meta property="og:image" content="og-image.png">
<meta name="twitter:card" content="summary_large_image">
<link rel="icon" type="image/svg+xml" href="favicon.svg">
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
...
<div class="main">
  <a href="journey.html" class="back">← Back to Journey</a>
  <div class="lesson-badge">Sales Mindset · Lesson 8 of 8</div>
  <h1 class="lesson-title">Becoming Interview Ready</h1>
  <div class="lesson-meta"><span>⏱ ~10 min</span><span>🏆 +50 XP</span><span>📖 Module 1: Sales Mindset</span></div>

  <!-- EXPLANATION -->
  <div class="lcard"><h2><span class="ic">📖</span> Lesson</h2><p>Everything you've learned in this module isn't just cold calling theory — it's <strong>exactly what hiring managers test for in SDR interviews.</strong></p><p>Interviewers aren't looking for polished sales veterans. They're looking for people who demonstrate: a growth mindset (Lesson 1), resilience (Lesson 2), willingness to practice (Lesson 3), curiosity (Lesson 4), work ethic (Lesson 5), consistency (Lesson 6), and a consultative approach (Lesson 7).</p><p>If you've completed the exercises in this module, you already have real examples to draw from — even without professional sales experience. Your practice sessions, rejection logs, and daily drills ARE the experience hiring managers want to hear about.</p></div>

  <!-- EXAMPLE -->
  <div class="lcard"><h2><span class="ic">💼</span> Real-World Example</h2><p><strong>Real SDR Example:</strong> Tom had no sales experience. In his interview, he said: "I've spent the last month training myself using a structured system. I've practiced my cold call opener over 200 times, logged 50+ simulated rejections, and tracked exactly which approaches work. I can show you my rejection log and my confidence progression." The hiring manager later said Tom was the most prepared entry-level candidate she'd ever seen — not because of his experience, but because of his process.</p></div>

  <!-- EXERCISE -->
  <div class="lcard"><h2><span class="ic">✏️</span> Practical Exercise</h2><p><strong>Exercise — Build Your SDR Portfolio:</strong> Create a simple document with:
1. Your best cold call opener (written out)
2. Your top 3 objection responses
3. Your rejection log (or a summary of what you learned)
4. Your daily practice routine
5. One paragraph on why you want to be an SDR</p><p>This is your "SDR portfolio." Bring it to every interview. It proves you've done the work.</p></div>

  <!-- REFLECTION -->
  <div class="reflect"><div class="reflect-q">💭 If a hiring manager asked you right now: 'What have you done to prepare for this role?' — do you have a concrete answer? If not, what would make your answer undeniable?</div></div>

  <!-- QUIZ -->
  <div class="lcard"><h2><span class="ic">🧠</span> Knowledge Check</h2><div class="q-item"><div class="q-num">Q1</div><div class="q-text">What do hiring managers value most in entry-level SDR candidates?</div><div class="q-opts"><label class="qopt" data-qi="0" data-oi="0"><input type="radio" name="q0"><span class="qo-text">A business degree</span></label><label class="qopt" data-qi="0" data-oi="1"><input type="radio" name="q0"><span class="qo-text">Prior sales experience</span></label><label class="qopt" data-qi="0" data-oi="2"><input type="radio" name="q0"><span class="qo-text">Growth mindset, resilience, and willingness to practice</span></label><label class="qopt" data-qi="0" data-oi="3"><input type="radio" name="q0"><span class="qo-text">Industry certifications</span></label></div><div class="q-fb" id="qfb0"></div></div><div class="q-item"><div class="q-num">Q2</div><div class="q-text">Tom impressed his interviewer because:</div><div class="q-opts"><label class="qopt" data-qi="1" data-oi="0"><input type="radio" name="q1"><span class="qo-text">He had years of experience</span></label><label class="qopt" data-qi="1" data-oi="1"><input type="radio" name="q1"><span class="qo-text">He showed a structured self-training process with evidence</span></label><label class="qopt" data-qi="1" data-oi="2"><input type="radio" name="q1"><span class="qo-text">He had a referral</span></label><label class="qopt" data-qi="1" data-oi="3"><input type="radio" name="q1"><span class="qo-text">He offered to work for free</span></label></div><div class="q-fb" id="qfb1"></div></div><div class="q-item"><div class="q-num">Q3</div><div class="q-text">An 'SDR Portfolio' should include:</div><div class="q-opts"><label class="qopt" data-qi="2" data-oi="0"><input type="radio" name="q2"><span class="qo-text">Your resume only</span></label><label class="qopt" data-qi="2" data-oi="1"><input type="radio" name="q2"><span class="qo-text">Your opener, objection responses, rejection log, and practice routine</span></label><label class="qopt" data-qi="2" data-oi="2"><input type="radio" name="q2"><span class="qo-text">A list of companies you want to work for</span></label><label class="qopt" data-qi="2" data-oi="3"><input type="radio" name="q2"><span class="qo-text">Screenshots of LinkedIn posts</span></label></div><div class="q-fb" id="qfb2"></div></div><div class="q-item"><div class="q-num">Q4</div><div class="q-text">Your practice sessions in AmplifyHub:</div><div class="q-opts"><label class="qopt" data-qi="3" data-oi="0"><input type="radio" name="q3"><span class="qo-text">Don't count as real experience</span></label><label class="qopt" data-qi="3" data-oi="1"><input type="radio" name="q3"><span class="qo-text">Are exactly the kind of preparation hiring managers look for</span></label><label class="qopt" data-qi="3" data-oi="2"><input type="radio" name="q3"><span class="qo-text">Should not be mentioned in interviews</span></label><label class="qopt" data-qi="3" data-oi="3"><input type="radio" name="q3"><span class="qo-text">Only matter if you got real results</span></label></div><div class="q-fb" id="qfb3"></div></div><button class="ai-btn" style="background:var(--accent);color:var(--bg);margin-top:14px" id="checkQuiz">Check Answers</button></div>

  <!-- DRILL -->
  <div class="lcard"><h2><span class="ic">🎯</span> Today's Drill</h2><p>Practice this interview answer aloud until it feels natural:</p><p><strong>"I've been training myself for this role for [X weeks]. I practice my cold call opener every day, I've logged dozens of simulated rejections to find patterns, and I've built a consultative approach where I lead with questions, not pitches. I don't have years of experience, but I have a system — and I can show you exactly how I've been improving."</strong></p><p>Focus on: steady pace, eye contact (imagine the interviewer), and genuine conviction.</p></div>

  <!-- AI COACH -->
  <div class="ai-card">
    <h2><span class="ic">🤖</span> Practice with AI Coach</h2>
    <p style="font-size:14px;color:var(--text);margin:8px 0"><strong>Prospect says:</strong> "This is an interview: why should we hire you as an SDR?"</p>
    <p style="font-size:13px;color:var(--text)"><strong>Your objective:</strong> Deliver a confident, structured answer using examples from your practice in this module.</p>
    <div class="ai-meta"><span>Difficulty: Hard</span><span>Goal: The learner practices translating their AmplifyHub training into interview-ready stories.</span></div>
    <a href="coach-home.html" class="ai-btn">Open AI Coach →</a>
  </div>
  ...
  <div class="iv-card">
    <h2><span class="ic">🎤</span> Interview Question</h2>
    <blockquote style="background:rgba(100,181,246,.06);border-left:3px solid var(--blue);border-radius:0 10px 10px 0;padding:14px 18px;margin:12px 0;font-style:italic;font-size:14px;color:var(--text)">"Why should we hire you with no experience?"</blockquote>
    <p style="font-size:13px;color:var(--text);margin:8px 0"><strong>Example answer:</strong> Because I've already started doing the job. I've been training on a structured cold calling system, practicing daily, logging my rejections, and refining my approach based on data. I don't have tenure, but I have reps, a system, and proof that I'm committed to getting better every day.</p>
    <div class="iv-tip">💡 This is your closer. Deliver it with conviction. Managers hire for trajectory, not history.</div>
  </div>

  <!-- TAKEAWAY -->
  <div class="takeaway"><p>🔑 You don't need experience to get hired. You need evidence that you've already started.</p></div>

  <!-- BOTTOM NAV -->
  <div class="bnav">
    <a href="sales-mindset-7.html" class="bnav-btn bnav-prev">← Previous Lesson</a>
    <button class="bnav-btn bnav-complete" id="completeBtn">Mark as Complete ✓</button>
    <a href="interview-prep.html" class="bnav-btn bnav-next">Build Your SDR Portfolio →</a>
  </div>
</div>
...
<script>
// ── PROGRESS SYNC (shared with journey.html + dashboard.html) ──
const STORAGE_KEY='amplifyHub_journeyProgress';
const MODULE_INDEX=0; // Sales Mindset is module 0
const LESSON_INDEX=7; // 0-indexed
// Compact module map (names + lesson counts) so summary fields stay correct for Dashboard
const MODULE_MAP=[
  ['Sales Mindset',8],['Finding Prospects',3],['Building Your Script',4],['Opening the Call',4],
  ['Discovery Questions',4],['Objection Handling',5],['Booking Appointments',1],['Follow-up',3],
  ['Live Practice',4],['Mastery',4]
];
const TOTAL_LESSONS=MODULE_MAP.reduce((s,m)=>s+m[1],0);

function readStore(){
  try{ return JSON.parse(localStorage.getItem(STORAGE_KEY))||{}; }catch(e){ return {}; }
}
function lid(m,l){ return \`m\${m}l\${l}\`; }
function saveProgress(completed, lessonMeta){
  // Recompute the summary fields Dashboard depends on (fixes sync)
  let done=0, curModule=MODULE_MAP.length-1;
  outer: for(let m=0;m<MODULE_MAP.length;m++){
    for(let l=0;l<MODULE_MAP[m][1];l++) if(completed.has(lid(m,l))) done++;
  }
  for(let m=0;m<MODULE_MAP.length;m++){
    let allDone=true;
    for(let l=0;l<MODULE_MAP[m][1];l++) if(!completed.has(lid(m,l))){allDone=false;break;}
    if(!allDone){ curModule=m; break; }
  }
  localStorage.setItem(STORAGE_KEY,JSON.stringify({
    completedLessons:[...completed],
    overallProgress: Math.round(done/TOTAL_LESSONS*100),
    lessonsCompleted: done,
    totalLessons: TOTAL_LESSONS,
    currentModuleName: MODULE_MAP[curModule][0],
...
const lessonMeta=store.lessonMeta||{};
const thisLid=lid(MODULE_INDEX,LESSON_INDEX);
const btn=document.getElementById('completeBtn');
...
if(completed.has(thisLid)){
  ...
  if(lastQuizScore!==null){
    ...
    s.textContent='🧠 Last quiz: '+lastQuizScore;
    meta.appendChild(s);
  }
}
...
btn.addEventListener('click',function(){
  if(completed.has(thisLid)) return;
  completed.add(thisLid);
  const minsSpent=Math.max(1,Math.round((Date.now()-pageLoadTime)/60000));
  lessonMeta[thisLid]={mins:minsSpent, quizScore:lastQuizScore, completedAt:Date.now()};
  saveProgress(completed,lessonMeta);
  btn.textContent='✓ Completed';
  btn.classList.add('done');
  const toast=document.getElementById('toast');
  toast.classList.add('show');
...
document.getElementById('checkQuiz').addEventListener('click',function(){
  let correct=0, answeredAny=false;
  document.querySelectorAll('.qopt').forEach(opt=>{
  ...
  document.querySelectorAll('.qopt').forEach(opt=>{
    ...
    if(!input.checked) return;
    answeredAny=true;
    if(oi===answers[qi]){ correct++; opt.classList.add('correct'); document.getElementById('qfb'+qi).textContent='✓ Correct!'; document.getElementById('qfb'+qi).style.color='var(--green)'; }
    else{ opt.classList.add('wrong'); document.getElementById('qfb'+qi).textContent='✗ Try again'; document.getElementById('qfb'+qi).style.color='var(--red)'; }
  });
  if(answeredAny){
    lastQuizScore=correct+'/'+answers.length;
    // Persist quiz score even before completion so it isn't lost
    lessonMeta[thisLid]=Object.assign(lessonMeta[thisLid]||{},{quizScore:lastQuizScore});
    saveProgress(completed,lessonMeta);
  }
});
...
`}],f=e=>{let t=new DOMParser().parseFromString(e,`text/html`).querySelector(`.main`);if(!t)throw Error(`Lesson source is missing its .main content container.`);let n=t.cloneNode(!0);return n.querySelectorAll(`.back, .lesson-badge, .lesson-title, .lesson-meta, .bnav`).forEach(e=>e.remove()),n.querySelectorAll(`a[href]`).forEach(e=>{let t=e.getAttribute(`href`);t&&/^[^/]+\.html(?:#.*)?$/.test(t)&&e.setAttribute(`href`,`../${t}`)}),{content:n.innerHTML}},p=`amplifyHub_journeyProgress`,m=[[`Sales Mindset`,8],[`Finding Prospects`,3],[`Building Your Script`,4],[`Opening the Call`,4],[`Discovery Questions`,4],[`Objection Handling`,5],[`Booking Appointments`,1],[`Follow-up`,3],[`Live Practice`,4],[`Mastery`,4]],h=()=>({completedLessons:[],lessonMeta:{}}),g=()=>{try{let e=localStorage.getItem(p);if(!e)return h();let t=JSON.parse(e);return{...t,completedLessons:Array.isArray(t.completedLessons)?t.completedLessons.filter(e=>typeof e==`string`):[],lessonMeta:t.lessonMeta??{}}}catch(e){return console.error(`Unable to read lesson progress.`,e),h()}},_=(e,t)=>{let n=new Set(e),r=m.reduce((e,[,t])=>e+t,0),i=m.at(-1)?.[0]??`Mastery`;for(let e=0;e<m.length;e+=1){let[t,r]=m[e];if(!Array.from({length:r},(t,r)=>n.has(`m${e}l${r}`)).every(Boolean)){i=t;break}}let a={completedLessons:[...n],overallProgress:Math.round(n.size/r*100),lessonsCompleted:n.size,totalLessons:r,currentModuleName:i,lessonMeta:t,updatedAt:Date.now()};return localStorage.setItem(p,JSON.stringify(a)),a},v=e((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),y=e(((e,t)=>{t.exports=v()}))(),b=()=>{let e=window.location.hash.match(/^#lesson-(\d+)$/),t=Number(e?.[1]??1);return Math.min(Math.max(t-1,0),d.length-1)},x=(e,t)=>e.checked?`${t.filter((t,n)=>e.selections[n]===t).length}/${t.length}`:null;function ee(){let e=(0,l.useMemo)(g,[]),[t,n]=(0,l.useState)(b),[r,i]=(0,l.useState)(()=>new Set(e.completedLessons)),[a,o]=(0,l.useState)(()=>e.lessonMeta??{}),[s,c]=(0,l.useState)({}),[u,p]=(0,l.useState)(!1),[m,h]=(0,l.useState)(null),v=(0,l.useRef)(Date.now()),ee=(0,l.useRef)(null),S=(0,l.useRef)(null),C=d[t],te=(0,l.useMemo)(()=>f(C.source),[C.source]),ne=s[t]??{selections:{},checked:!1},re=d.filter(({id:e})=>r.has(e)).length,w=r.has(C.id),ie=re/d.length*100,ae=(e,t=!1)=>{let r=Math.min(Math.max(e,0),d.length-1),i=`#lesson-${r+1}`;window.history[t?`replaceState`:`pushState`](null,``,i),v.current=Date.now(),n(r),p(!1),window.scrollTo({top:0,behavior:`smooth`})};(0,l.useEffect)(()=>{window.location.hash||ae(0,!0);let e=()=>{v.current=Date.now(),n(b()),p(!1)};return window.addEventListener(`hashchange`,e),window.addEventListener(`popstate`,e),()=>{window.removeEventListener(`hashchange`,e),window.removeEventListener(`popstate`,e)}},[]),(0,l.useEffect)(()=>{document.title=`${C.title} | AmplifyHub`,ee.current?.focus({preventScroll:!0})},[C.title]),(0,l.useEffect)(()=>{let e=S.current;e&&(e.querySelectorAll(`.qopt`).forEach(e=>{let t=Number(e.dataset.qi),n=Number(e.dataset.oi),r=ne.selections[t]===n,i=ne.checked&&r&&C.answers[t]===n,a=ne.checked&&r&&C.answers[t]!==n,o=e.querySelector(`input[type="radio"]`);o&&(o.checked=r),e.classList.toggle(`correct`,i),e.classList.toggle(`wrong`,a)}),e.querySelectorAll(`.q-item`).forEach((e,t)=>{let n=e.querySelector(`.q-fb`);if(!n)return;let r=ne.selections[t];if(!ne.checked||r===void 0){n.textContent=``,n.removeAttribute(`style`);return}let i=r===C.answers[t];n.textContent=i?`✓ Correct!`:`✕ Try again`,n.style.color=i?`var(--green)`:`var(--red)`}))},[C.answers,te.content,ne]),(0,l.useEffect)(()=>{let e=e=>{e.target?.matches(`input, textarea, select, button, a, summary`)||(e.key===`ArrowLeft`&&t>0&&ae(t-1),e.key===`ArrowRight`&&t<d.length-1&&ae(t+1))};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[t]),(0,l.useEffect)(()=>{if(!m)return;let e=window.setTimeout(()=>h(null),2800);return()=>window.clearTimeout(e)},[m]);let oe=e=>{let t=x(e,C.answers);if(!t)return;let n={...a,[C.id]:{...a[C.id],quizScore:t}};try{_(r,n),o(n)}catch(e){console.error(`Unable to save quiz progress.`,e),h(`Progress could not be saved in this browser.`)}};return(0,y.jsxs)(`div`,{className:`app-shell`,children:[(0,y.jsxs)(`header`,{className:`mobile-header`,children:[(0,y.jsxs)(`a`,{className:`brand`,href:`../dashboard.html`,"aria-label":`AmplifyHub dashboard`,children:[`Amplify`,(0,y.jsx)(`span`,{children:`Hub`})]}),(0,y.jsxs)(`button`,{className:`menu-button`,type:`button`,"aria-expanded":u,"aria-controls":`course-navigation`,onClick:()=>p(e=>!e),children:[(0,y.jsx)(`span`,{"aria-hidden":`true`,children:`☰`}),(0,y.jsx)(`span`,{className:`sr-only`,children:`Toggle lesson navigation`})]})]}),u&&(0,y.jsx)(`button`,{className:`sidebar-scrim`,type:`button`,"aria-label":`Close lesson navigation`,onClick:()=>p(!1)}),(0,y.jsxs)(`aside`,{id:`course-navigation`,className:`course-sidebar${u?` open`:``}`,children:[(0,y.jsxs)(`div`,{children:[(0,y.jsxs)(`a`,{className:`brand`,href:`../dashboard.html`,"aria-label":`AmplifyHub dashboard`,children:[`Amplify`,(0,y.jsx)(`span`,{children:`Hub`})]}),(0,y.jsx)(`a`,{className:`back-link`,href:`../journey.html`,children:`← Back to Journey`})]}),(0,y.jsxs)(`div`,{className:`course-summary`,children:[(0,y.jsx)(`span`,{className:`eyebrow`,children:`Module 1`}),(0,y.jsx)(`h2`,{children:`Sales Mindset`}),(0,y.jsxs)(`p`,{children:[re,` of `,d.length,` lessons complete`]}),(0,y.jsx)(`div`,{className:`progress-track`,role:`progressbar`,"aria-label":`Module completion`,"aria-valuemin":0,"aria-valuemax":d.length,"aria-valuenow":re,children:(0,y.jsx)(`span`,{style:{width:`${ie}%`}})})]}),(0,y.jsx)(`nav`,{"aria-label":`Sales mindset lessons`,children:(0,y.jsx)(`ol`,{className:`lesson-list`,children:d.map((e,n)=>{let i=n===t,a=r.has(e.id);return(0,y.jsx)(`li`,{children:(0,y.jsxs)(`button`,{className:`lesson-tab${i?` active`:``}${a?` completed`:``}`,type:`button`,"aria-current":i?`step`:void 0,onClick:()=>ae(n),children:[(0,y.jsx)(`span`,{className:`step-number`,"aria-hidden":`true`,children:a?`✓`:e.number}),(0,y.jsxs)(`span`,{children:[(0,y.jsx)(`strong`,{children:e.shortTitle}),(0,y.jsx)(`small`,{children:e.duration})]})]})},e.id)})})})]}),(0,y.jsxs)(`main`,{className:`lesson-main`,children:[(0,y.jsxs)(`div`,{className:`lesson-header`,children:[(0,y.jsxs)(`div`,{className:`lesson-badge`,children:[`Sales Mindset · Lesson `,C.number,` of `,d.length,w&&` · ↻ Review Mode`]}),(0,y.jsx)(`h1`,{ref:ee,className:`lesson-title`,tabIndex:-1,children:C.title}),(0,y.jsxs)(`div`,{className:`lesson-meta`,children:[(0,y.jsxs)(`span`,{children:[`⏱ `,C.duration]}),(0,y.jsxs)(`span`,{children:[`🏆 +`,C.xp,` XP`]}),(0,y.jsx)(`span`,{children:`📖 Module 1: Sales Mindset`}),a[C.id]?.quizScore&&(0,y.jsxs)(`span`,{children:[`🧠 Last quiz: `,a[C.id].quizScore]})]})]}),(0,y.jsx)(`div`,{ref:S,className:`lesson-content`,onClick:e=>{let n=e.target,r=n.closest(`.qopt`);if(r){e.preventDefault();let n=Number(r.dataset.qi),i=Number(r.dataset.oi);if(!Number.isInteger(n)||!Number.isInteger(i))return;c(e=>({...e,[t]:{selections:{...e[t]?.selections??{},[n]:i},checked:!1}}));return}if(n.closest(`#checkQuiz`)){e.preventDefault();let n={...ne,checked:!0};c(e=>({...e,[t]:n})),oe(n)}},dangerouslySetInnerHTML:{__html:te.content}}),(0,y.jsxs)(`nav`,{className:`bottom-navigation`,"aria-label":`Lesson controls`,children:[(0,y.jsx)(`button`,{className:`nav-button secondary`,type:`button`,disabled:t===0,onClick:()=>ae(t-1),children:`← Previous`}),(0,y.jsx)(`button`,{className:`nav-button complete${w?` done`:``}`,type:`button`,disabled:w,onClick:()=>{if(w)return;let e=new Set(r).add(C.id),t=x(ne,C.answers)??a[C.id]?.quizScore,n={...a,[C.id]:{...a[C.id],mins:Math.max(1,Math.round((Date.now()-v.current)/6e4)),quizScore:t,completedAt:Date.now()}};try{_(e,n),i(e),o(n),h(`Lesson ${C.number} complete · +${C.xp} XP`)}catch(e){console.error(`Unable to save lesson completion.`,e),h(`Progress could not be saved in this browser.`)}},children:w?`✓ Completed`:`Mark as Complete`}),t<d.length-1?(0,y.jsx)(`button`,{className:`nav-button secondary`,type:`button`,onClick:()=>ae(t+1),children:`Next →`}):(0,y.jsx)(`a`,{className:`nav-button secondary`,href:`../interview-prep.html`,children:`Build Portfolio →`})]})]}),(0,y.jsx)(`div`,{className:`toast${m?` show`:``}`,role:`status`,"aria-live":`polite`,children:m})]})}var S=document.getElementById(`root`);if(!S)throw Error(`Unable to start the app: #root was not found.`);(0,u.createRoot)(S).render((0,y.jsx)(l.StrictMode,{children:(0,y.jsx)(ee,{})}));