...
--
-- WHY: the roleplay flow saves scenario/persona/difficulty/goal/status when
-- a session starts, and the end-of-session flow saves the feedback report
-- and per-skill scores. The Progress page ("View Report") and the feedback
-- grader read them back. Without these columns, that data is silently
-- dropped on write.
--
